...
type_inference = {
  ...
  'leaky_relu_backward.grad_input': 'EQ_FOURTH',
  ...
  'linalg_vector_norm.out': 'EQ_FOURTH',
  'log': 'TO_FLOAT',
  'log.out': 'EQ_SECOND',
  'log10': 'TO_FLOAT',
  'log10.out': 'EQ_SECOND',
...
shape_inference = {
  ...
  'fake_quantize_per_channel_affine_cachemask_backward': 'STD_PROMOTE',
  'fake_quantize_per_tensor_affine': 'EQ_FIRST',
  'fake_quantize_per_tensor_affine.tensor_qparams': 'EQ_FIRST',
  'fake_quantize_per_tensor_affine_cachemask_backward': 'STD_PROMOTE',
  ...
  'hardtanh_backward.grad_input': 'PROMOTE_1_2',
  ...
  'huber_loss_backward.out': 'PROMOTE_1_2_3',
  'hypot': 'STD_PROMOTE',
  ...
  'isin.Scalar_Tensor_out': 'ALL []',
  'isin.Tensor_Scalar': 'EQ_FIRST',
  'isin.Tensor_Scalar_out': 'EQ_FIRST',
  'isin.Tensor_Tensor': 'EQ_FIRST',
  'isin.Tensor_Tensor_out': 'EQ_FIRST',
  'isinf': 'EQ_FIRST',
  'isnan': 'EQ_FIRST',
  'isneginf': 'EQ_FIRST',
  'isneginf.out': 'EQ_FIRST',
  'isposinf': 'EQ_FIRST',
  'isposinf.out': 'EQ_FIRST',
  'isreal': 'EQ_FIRST',
  'istft': 'ALL [1]',
  ...
  'l1_loss_backward.grad_input': 'PROMOTE_1_2_3',
  'layer_norm': 'EQ_FIRST',
  'lcm': 'STD_PROMOTE',
  'lcm.out': 'PROMOTE_1_2',
  'lcm_': 'EQ_FIRST',
  ...
  'leaky_relu_backward.grad_input': 'PROMOTE_1_2',
  ...
  'mse_loss_backward.grad_input': 'PROMOTE_1_2_3',
  'msort': 'EQ_FIRST',
  'msort.out': 'EQ_FIRST',
  'mul.Scalar': 'EQ_FIRST',
  ...
  'smooth_l1_loss_backward.grad_input': 'PROMOTE_1_2_3',
  'soft_margin_loss_backward': 'STD_PROMOTE',
  'soft_margin_loss_backward.grad_input': 'PROMOTE_1_2_3',
  ...
  'where.Scalar': 'EQ_FIRST',
  'where.self': 'STD_PROMOTE',
...
strides_inference = {
  ...
  '__ixor__.Scalar': 'EQ_FIRST',
  '__ixor__.Tensor': 'EQ_FIRST',
  '__lshift__.Scalar': 'CLONE1',
  '__lshift__.Tensor': 'STD_PROMOTE',
  '__or__.Scalar': 'CLONE1',
  '__or__.Tensor': 'STD_PROMOTE',
  '__rshift__.Scalar': 'CLONE1',
  '__rshift__.Tensor': 'STD_PROMOTE',
  '__xor__.Scalar': 'CLONE1',
  '__xor__.Tensor': 'STD_PROMOTE',
  '_adaptive_avg_pool2d': 'CONTIGUOUS',
  '_adaptive_avg_pool3d': 'CONTIGUOUS',
  '_adaptive_avg_pool3d_backward': 'ALL [54, 6, 2, 1]',
  '_add_relu.Scalar': 'CLONE1',
  '_add_relu.Tensor': 'STD_PROMOTE',
  '_add_relu_.Scalar': 'EQ_FIRST',
  '_add_relu_.Tensor': 'EQ_FIRST',
  '_autocast_to_full_precision': 'EQ_FIRST',
  '_autocast_to_reduced_precision': 'EQ_FIRST',
  '_cast_Byte': 'CLONE_CONTIGOUS2',
  '_cast_Char': 'CLONE_CONTIGOUS2',
  '_cast_Double': 'CLONE_CONTIGOUS2',
  '_cast_Float': 'EQ_FIRST',
  '_cast_Half': 'CLONE_CONTIGOUS2',
  '_cast_Int': 'CLONE_CONTIGOUS2',
  '_cast_Long': 'CLONE_CONTIGOUS2',
  '_cast_Short': 'CLONE_CONTIGOUS2',
  '_cdist_forward': 'CONTIGUOUS',
  '_compute_linear_combination': 'CONTIGUOUS',
  '_conj_physical': 'STD_PROMOTE',
  '_convolution_nogroup': 'CONTIGUOUS',
  '_dim_arange': 'ALL [1]',
  '_grid_sampler_2d_cpu_fallback': 'ALL [243, 27, 3, 1]',
  '_histogramdd_from_bin_cts': 'CONTIGUOUS',
  '_index_copy_': 'EQ_FIRST',
  '_log_softmax': 'CONTIGUOUS',
  '_logcumsumexp': 'CONTIGUOUS',
  '_neg_view': 'EQ_FIRST',
  '_pdist_forward': 'ALL [1]',
  '_sample_dirichlet': 'CONTIGUOUS',
  '_shape_as_tensor': 'ALL [1]',
  '_softmax': 'CONTIGUOUS',
  '_softmax_backward_data': 'CONTIGUOUS',
  '_sparse_addmm': 'CONTIGUOUS',
  '_sparse_mm': 'CONTIGUOUS',
  '_stack': 'CONTIGUOUS',
  '_standard_gamma': 'CONTIGUOUS',
  '_test_ambiguous_defaults.a': 'ALL []',
  '_test_optional_filled_intlist': 'EQ_FIRST',
  '_test_optional_floatlist': 'EQ_FIRST',
  '_test_optional_intlist': 'EQ_FIRST',
  '_to_copy': 'CLONE3',
  '_unsafe_view': 'VIEW',
  '_upsample_bilinear2d_aa': 'CONTIGUOUS',
  '_upsample_bilinear2d_aa.out': 'CONTIGUOUS',
  '_upsample_nearest_exact2d': 'CONTIGUOUS',
  '_upsample_nearest_exact2d.out': 'CONTIGUOUS',
  'abs': 'STD_PROMOTE',
  'abs_': 'EQ_FIRST',
  'absolute': 'STD_PROMOTE',
  'absolute_': 'EQ_FIRST',
  'acos': 'STD_PROMOTE',
  'acos_': 'EQ_FIRST',
  'acosh': 'STD_PROMOTE',
  'acosh_': 'EQ_FIRST',
  'adaptive_avg_pool2d': 'CONTIGUOUS',
  'adaptive_avg_pool3d': 'CONTIGUOUS',
  'adaptive_avg_pool3d.out': 'CONTIGUOUS',
  'add.Scalar': 'CLONE1',
  'add.Tensor': 'STD_PROMOTE',
  'add_.Scalar': 'EQ_FIRST',
  'add_.Tensor': 'EQ_FIRST',
  ...
  'addcmul_': 'EQ_FIRST',
  'addmm': 'CONTIGUOUS',
  'addmm.out': 'CONTIGUOUS',
  'alias': 'EQ_FIRST',
  'all': 'ALL []',
  'all.all_out': 'ALL []',
  'all.dim': 'CONTIGUOUS',
  'alpha_dropout': 'CLONE_BOOL',
  'alpha_dropout_': 'EQ_FIRST',
  'amax': 'CONTIGUOUS',
  'amin': 'CONTIGUOUS',
  'angle': 'STD_PROMOTE',
  ...
  'atleast_1d': 'EQ_FIRST',
  'atleast_2d': 'EQ_FIRST',
  'avg_pool2d': 'CONTIGUOUS',
  'avg_pool2d_backward': 'ALL [2, 2, 1]',
  'avg_pool2d_backward.grad_input': 'ALL [1, 1, 3]',
  'avg_pool3d': 'ALL [4, 1, 1, 1]',
  'avg_pool3d.out': 'ALL [4, 1, 1, 1]',
  'baddbmm': 'ALL [1, 1, 1]',
  'baddbmm.out': 'ALL [1, 1, 1]',
  'bartlett_window': 'ALL [1]',
  'bartlett_window.periodic': 'ALL [1]',
  'bernoulli': 'CONTIGUOUS',
  'bernoulli.p': 'CONTIGUOUS',
  'bernoulli_.Tensor': 'EQ_FIRST',
  'bernoulli_.float': 'EQ_FIRST',
  'binary_cross_entropy_backward.grad_input': 'EQ_FIRST',
  'bitwise_and.Scalar': 'CLONE1',
  'bitwise_and.Tensor': 'STD_PROMOTE',
  'bitwise_and_.Scalar': 'EQ_FIRST',
  'bitwise_and_.Tensor': 'EQ_FIRST',
  'bitwise_left_shift.Scalar_Tensor': 'CLONE1',
  'bitwise_left_shift.Tensor': 'STD_PROMOTE',
  'bitwise_left_shift.Tensor_Scalar': 'CLONE1',
  'bitwise_left_shift_.Tensor': 'EQ_FIRST',
  'bitwise_left_shift_.Tensor_Scalar': 'EQ_FIRST',
  'bitwise_not': 'STD_PROMOTE',
  'bitwise_not_': 'EQ_FIRST',
  'bitwise_or.Scalar': 'CLONE1',
  'bitwise_or.Tensor': 'STD_PROMOTE',
  'bitwise_or_.Scalar': 'EQ_FIRST',
  'bitwise_or_.Tensor': 'EQ_FIRST',
  'bitwise_right_shift.Scalar_Tensor': 'CLONE1',
  'bitwise_right_shift.Tensor': 'STD_PROMOTE',
  'bitwise_right_shift.Tensor_Scalar': 'CLONE1',
  'bitwise_right_shift_.Tensor': 'EQ_FIRST',
  'bitwise_right_shift_.Tensor_Scalar': 'EQ_FIRST',
  'bitwise_xor.Scalar': 'CLONE1',
  'bitwise_xor.Tensor': 'STD_PROMOTE',
  'bitwise_xor_.Scalar': 'EQ_FIRST',
  'bitwise_xor_.Tensor': 'EQ_FIRST',
  'blackman_window': 'ALL [1]',
  'blackman_window.periodic': 'ALL [1]',
  'block_diag': 'CONTIGUOUS',
  'bmm': 'ALL [1, 1, 1]',
  'bmm.out': 'ALL [1, 1, 1]',
  'broadcast_to': 'EXPAND',
  'cat': 'CONTIGUOUS',
  ...
  'celu': 'STD_PROMOTE',
  'celu_': 'EQ_FIRST',
  'chain_matmul': 'CONTIGUOUS',
  'chain_matmul.out': 'CONTIGUOUS',
  'channel_shuffle': 'CONTIGUOUS',
  'cholesky': 'CONTIGUOUS',
  'clamp': 'STD_PROMOTE',
  'clamp.Tensor': 'STD_PROMOTE',
  'clamp_': 'EQ_FIRST',
  'clamp_.Tensor': 'EQ_FIRST',
  'clamp_max': 'STD_PROMOTE',
  'clamp_max.Tensor': 'STD_PROMOTE',
  'clamp_max_': 'EQ_FIRST',
  'clamp_max_.Tensor': 'EQ_FIRST',
  'clamp_min': 'STD_PROMOTE',
  'clamp_min.Tensor': 'STD_PROMOTE',
  'clamp_min_': 'EQ_FIRST',
  'clamp_min_.Tensor': 'EQ_FIRST',
  'clip': 'STD_PROMOTE',
  ...
  'clone': 'CLONE',
  'col2im': 'CONTIGUOUS',
  'col2im.out': 'CONTIGUOUS',
  'col2im_backward': 'CONTIGUOUS',
  'col2im_backward.grad_input': 'CONTIGUOUS',
  'column_stack': 'CONTIGUOUS',
  'complex': 'STD_PROMOTE',
  'concat': 'CONTIGUOUS',
  'conj': 'EQ_FIRST',
  'conj_physical': 'EQ_FIRST',
  'conj_physical_': 'EQ_FIRST',
  'constant_pad_nd': 'CONTIGUOUS',
  'contiguous': 'CLONE_CONTIGOUS2',
  'copy_': 'EQ_FIRST',
  'copysign.Scalar': 'CLONE1',
  'copysign.Tensor': 'STD_PROMOTE',
  'copysign_.Scalar': 'EQ_FIRST',
  'copysign_.Tensor': 'EQ_FIRST',
  'corrcoef': 'CONTIGUOUS',
  ...
  'cosh': 'STD_PROMOTE',
  'cosh_': 'EQ_FIRST',
  'cosine_similarity': 'CONTIGUOUS',
  'count_nonzero': 'CONTIGUOUS',
  'count_nonzero.dim_IntList': 'CONTIGUOUS',
  'cov': 'CONTIGUOUS',
  'cross': 'CONTIGUOUS',
  'cross_entropy_loss': 'ALL []',
  'ctc_loss.IntList': 'CONTIGUOUS',
  'cumprod': 'CONTIGUOUS',
  'cumprod_': 'EQ_FIRST',
  'cumsum': 'CONTIGUOUS',
  'cumsum_': 'EQ_FIRST',
  'cumulative_trapezoid.dx': 'CONTIGUOUS',
  'data': 'EQ_FIRST',
  'deg2rad_': 'EQ_FIRST',
  'dequantize.self': 'EQ_FIRST',
  'detach': 'EQ_FIRST',
  ...
  'diag.out': 'ALL [1]',
  'diag_backward': 'ALL [1]',
  'diag_embed': 'CONTIGUOUS',
  'diagflat': 'CONTIGUOUS',
  'diagonal_backward': 'CONTIGUOUS',
  'digamma': 'STD_PROMOTE',
  'digamma_': 'EQ_FIRST',
  'dist': 'ALL []',
  'div.Scalar': 'CLONE1',
  'div.Scalar_mode': 'CLONE1',
  'div.Tensor': 'STD_PROMOTE',
  'div.Tensor_mode': 'STD_PROMOTE',
  'div_.Scalar': 'EQ_FIRST',
  'div_.Scalar_mode': 'EQ_FIRST',
  'div_.Tensor': 'EQ_FIRST',
  'div_.Tensor_mode': 'EQ_FIRST',
  'divide.Scalar': 'CLONE1',
  'divide.Scalar_mode': 'CLONE1',
  'divide.Tensor': 'STD_PROMOTE',
  'divide.Tensor_mode': 'STD_PROMOTE',
  'divide_.Scalar': 'EQ_FIRST',
  'divide_.Scalar_mode': 'EQ_FIRST',
  ...
  'elu_backward.grad_input': 'EQ_FIRST',
  'empty.memory_format': 'CONTIGUOUS',
  'empty.names': 'CONTIGUOUS',
  'empty_like': 'CLONE',
  'eq.Scalar': 'CLONE1',
  'eq.Tensor': 'STD_PROMOTE',
  'eq_.Scalar': 'EQ_FIRST',
  ...
  'eye.m': 'CONTIGUOUS',
  'eye.out': 'CONTIGUOUS',
  'feature_alpha_dropout': 'CLONE_BOOL',
  'feature_alpha_dropout_': 'EQ_FIRST',
  'feature_dropout': 'CLONE_BOOL',
  'feature_dropout_': 'EQ_FIRST',
  'fft_fftfreq': 'ALL [1]',
  'fft_hfftn': 'CONTIGUOUS',
  'fft_irfftn': 'CONTIGUOUS',
  'fft_rfftfreq': 'ALL [1]',
  'fill_.Scalar': 'EQ_FIRST',
  'fill_diagonal_': 'EQ_FIRST',
  'fix': 'STD_PROMOTE',
  'fix_': 'EQ_FIRST',
  'flatten.using_ints': 'FLATTEN',
  'flatten_dense_tensors': 'ALL [1]',
  'float_power.Scalar': 'CONTIGUOUS',
  'float_power.Tensor_Scalar': 'CONTIGUOUS',
  'floor': 'STD_PROMOTE',
  'floor_': 'EQ_FIRST',
  'floor_divide': 'STD_PROMOTE',
  'floor_divide.Scalar': 'CLONE1',
  'floor_divide_.Scalar': 'EQ_FIRST',
  'floor_divide_.Tensor': 'EQ_FIRST',
  'fmax': 'STD_PROMOTE',
  'fmin': 'STD_PROMOTE',
  ...
  'frac_': 'EQ_FIRST',
  'frobenius_norm': 'ALL []',
  'frobenius_norm.dim': 'CONTIGUOUS',
  'from_file': 'ALL [1]',
  'full': 'CONTIGUOUS',
  'full.names': 'CONTIGUOUS',
  'full_like': 'CLONE',
  'gather': 'CONTIGUOUS',
  'gcd': 'STD_PROMOTE',
  'gcd_': 'EQ_FIRST',
  ...
  'gelu_backward': 'STD_PROMOTE',
  'glu': 'STD_PROMOTE',
  'glu_backward': 'CONTIGUOUS',
  'greater.Scalar': 'CLONE1',
  'greater.Tensor': 'STD_PROMOTE',
  'greater_.Scalar': 'EQ_FIRST',
  'greater_.Tensor': 'EQ_FIRST',
  'greater_equal.Scalar': 'CLONE1',
  'greater_equal.Tensor': 'STD_PROMOTE',
  'greater_equal_.Scalar': 'EQ_FIRST',
  'greater_equal_.Tensor': 'EQ_FIRST',
  'grid_sampler': 'ALL [243, 27, 3, 1]',
  'grid_sampler_2d': 'ALL [243, 27, 3, 1]',
  'gt.Scalar': 'CLONE1',
  'gt.Tensor': 'STD_PROMOTE',
  'gt_.Scalar': 'EQ_FIRST',
  'gt_.Tensor': 'EQ_FIRST',
  'hamming_window': 'ALL [1]',
  'hamming_window.periodic': 'ALL [1]',
  'hamming_window.periodic_alpha': 'ALL [1]',
  'hamming_window.periodic_alpha_beta': 'ALL [1]',
  'hann_window': 'ALL [1]',
  'hann_window.periodic': 'ALL [1]',
  'hardshrink': 'STD_PROMOTE',
  'hardshrink_backward': 'STD_PROMOTE',
  'hardsigmoid': 'STD_PROMOTE',
  'hardsigmoid_': 'EQ_FIRST',
  'hardsigmoid_backward': 'STD_PROMOTE',
  'hardswish': 'STD_PROMOTE',
  'hardswish_': 'EQ_FIRST',
  'hardswish_backward': 'STD_PROMOTE',
  'hardtanh': 'STD_PROMOTE',
  'hardtanh_': 'EQ_FIRST',
  'hardtanh_backward': 'STD_PROMOTE',
  'heaviside': 'STD_PROMOTE',
  'heaviside_': 'EQ_FIRST',
  'hinge_embedding_loss': 'CONTIGUOUS',
  'histc': 'ALL [1]',
  'histc.out': 'ALL [1]',
  'hstack': 'CONTIGUOUS',
  'hypot': 'STD_PROMOTE',
  ...
  'igammac_': 'EQ_FIRST',
  'im2col': 'CONTIGUOUS',
  'im2col.out': 'CONTIGUOUS',
  'im2col_backward': 'CONTIGUOUS',
  'im2col_backward.grad_input': 'CONTIGUOUS',
  'inner': 'CONTIGUOUS',
  'inverse': 'CONTIGUOUS',
  'isclose': 'STD_PROMOTE',
  'isin.Scalar_Tensor': 'ALL []',
  'isin.Scalar_Tensor_out': 'ALL []',
  'isin.Tensor_Scalar': 'CONTIGUOUS',
  'isin.Tensor_Tensor': 'CONTIGUOUS',
  'isinf': 'STD_PROMOTE',
  'isnan': 'STD_PROMOTE',
  'isneginf': 'STD_PROMOTE',
  'isposinf': 'STD_PROMOTE',
  'istft': 'ALL [1]',
  'kaiser_window': 'ALL [1]',
  'kaiser_window.beta': 'ALL [1]',
  'kaiser_window.periodic': 'ALL [1]',
  'layer_norm': 'CONTIGUOUS',
  'lcm': 'STD_PROMOTE',
  'lcm_': 'EQ_FIRST',
  'ldexp_': 'EQ_FIRST',
  'le.Scalar': 'CLONE1',
  ...
  'less_.Scalar': 'EQ_FIRST',
  'less_.Tensor': 'EQ_FIRST',
  'less_equal.Scalar': 'CLONE1',
  'less_equal.Tensor': 'STD_PROMOTE',
  'less_equal_.Scalar': 'EQ_FIRST',
  'less_equal_.Tensor': 'EQ_FIRST',
  'lgamma': 'STD_PROMOTE',
  'lgamma_': 'EQ_FIRST',
  'linalg_cond': 'CONTIGUOUS',
  'linalg_cond.out': 'CONTIGUOUS',
  'linalg_cross': 'CONTIGUOUS',
  'linalg_householder_product': 'ALL [2, 1, 2]',
  'linalg_matmul': 'CONTIGUOUS',
  'linalg_matmul.out': 'CONTIGUOUS',
  'linalg_matrix_norm': 'CONTIGUOUS',
  'linalg_matrix_rank': 'CONTIGUOUS',
  'linalg_matrix_rank.atol_rtol_float': 'CONTIGUOUS',
  'linalg_matrix_rank.atol_rtol_float_out': 'CONTIGUOUS',
  'linalg_matrix_rank.atol_rtol_tensor': 'CONTIGUOUS',
  'linalg_matrix_rank.atol_rtol_tensor_out': 'CONTIGUOUS',
  'linalg_matrix_rank.out': 'CONTIGUOUS',
  'linalg_matrix_rank.out_tol_tensor': 'CONTIGUOUS',
  'linalg_matrix_rank.tol_tensor': 'CONTIGUOUS',
  'linalg_multi_dot': 'CONTIGUOUS',
  'linalg_multi_dot.out': 'CONTIGUOUS',
  'linalg_norm': 'CONTIGUOUS',
  'linalg_norm.out': 'CONTIGUOUS',
  'linalg_pinv': 'CONTIGUOUS',
  'linalg_pinv.atol_rtol_float': 'CONTIGUOUS',
  'linalg_pinv.atol_rtol_tensor': 'CONTIGUOUS',
  'linalg_pinv.out_rcond_tensor': 'CONTIGUOUS',
  'linalg_pinv.rcond_tensor': 'CONTIGUOUS',
  'linalg_svdvals': 'CONTIGUOUS',
  'linalg_tensorsolve': 'ALL [1]',
  'linalg_tensorsolve.out': 'ALL [1]',
  'linalg_vector_norm': 'CONTIGUOUS',
  'linalg_vector_norm.out': 'CONTIGUOUS',
  'linear': 'CONTIGUOUS',
  'linspace': 'ALL [1]',
  'log': 'STD_PROMOTE',
  'log10': 'STD_PROMOTE',
  ...
  'log_': 'EQ_FIRST',
  'log_normal_': 'EQ_FIRST',
  'log_sigmoid': 'CONTIGUOUS',
  'log_softmax.int': 'CONTIGUOUS',
  'logaddexp': 'STD_PROMOTE',
  'logaddexp2': 'STD_PROMOTE',
  'logcumsumexp': 'CONTIGUOUS',
  'logical_and': 'STD_PROMOTE',
  'logical_and_': 'EQ_FIRST',
  'logical_not': 'STD_PROMOTE',
  'logical_not_': 'EQ_FIRST',
  'logical_or': 'STD_PROMOTE',
  'logical_or_': 'EQ_FIRST',
  'logical_xor': 'STD_PROMOTE',
  ...
  'lt_.Scalar': 'EQ_FIRST',
  'lt_.Tensor': 'EQ_FIRST',
  'masked_fill.Scalar': 'CONTIGUOUS',
  'masked_fill_.Scalar': 'EQ_FIRST',
  'masked_scatter': 'CONTIGUOUS',
  'masked_scatter_': 'EQ_FIRST',
  'masked_select': 'ALL [1]',
  'masked_select.out': 'ALL [1]',
  'matmul': 'CONTIGUOUS',
  'matmul.out': 'CONTIGUOUS',
  'matrix_H': 'TRANSPOSE2D',
  'matrix_rank': 'CONTIGUOUS',
  'matrix_rank.tol': 'CONTIGUOUS',
  'max': 'ALL []',
  'max.other': 'STD_PROMOTE',
  'max_pool2d': 'CONTIGUOUS',
  'max_pool3d': 'CONTIGUOUS',
  'maximum': 'STD_PROMOTE',
  'mean': 'ALL []',
  'mean.dim': 'CONTIGUOUS',
  'median': 'ALL []',
  ...
  'mul_.Scalar': 'EQ_FIRST',
  'mul_.Tensor': 'EQ_FIRST',
  'multinomial': 'CONTIGUOUS',
  'multiply.Scalar': 'CLONE1',
  'multiply.Tensor': 'STD_PROMOTE',
  'multiply_.Scalar': 'EQ_FIRST',
  'multiply_.Tensor': 'EQ_FIRST',
  'mvlgamma': 'CONTIGUOUS',
  ...
  'nanmean': 'CONTIGUOUS',
  'nanmedian': 'ALL []',
  'nanquantile.scalar': 'CONTIGUOUS',
  'nansum': 'ALL []',
  'nansum.dim_IntList': 'CONTIGUOUS',
  'narrow': 'EQ_FIRST',
  'native_dropout_backward': 'STD_PROMOTE',
  'ne.Scalar': 'CLONE1',
  'ne.Tensor': 'STD_PROMOTE',
  ...
  'neg': 'STD_PROMOTE',
  'neg_': 'EQ_FIRST',
  'negative': 'STD_PROMOTE',
  'negative_': 'EQ_FIRST',
  'new_empty': 'CONTIGUOUS',
  'new_full': 'CONTIGUOUS',
  'new_ones': 'CONTIGUOUS',
  'new_zeros': 'CONTIGUOUS',
  'nextafter': 'STD_PROMOTE',
  'nextafter_': 'EQ_FIRST',
  'nll_loss_nd': 'ALL []',
  'norm.Scalar': 'ALL []',
  'norm.ScalarOpt_dim': 'CONTIGUOUS',
  'norm.ScalarOpt_dim_dtype': 'CONTIGUOUS',
  'norm.ScalarOpt_dtype': 'ALL []',
  'norm.dtype_out': 'FLATTEN',
  'normal.Tensor_Tensor': 'CONTIGUOUS',
  'normal.Tensor_float': 'CONTIGUOUS',
  'normal.Tensor_float_out': 'EQ_SECOND',
  'normal.float_Tensor': 'CONTIGUOUS',
  'normal.float_Tensor_out': 'EQ_SECOND',
  'normal.float_float': 'CONTIGUOUS',
  'normal_': 'EQ_FIRST',
  'not_equal.Scalar': 'CLONE1',
  'not_equal.Tensor': 'STD_PROMOTE',
  'not_equal_.Scalar': 'EQ_FIRST',
  'not_equal_.Tensor': 'EQ_FIRST',
  'nuclear_norm': 'CONTIGUOUS',
  'nuclear_norm.dim': 'CONTIGUOUS',
  'nuclear_norm.out': 'CONTIGUOUS',
  'numpy_T': 'TRANSPOSE2D',
  'ones': 'CONTIGUOUS',
  'ones.names': 'CONTIGUOUS',
  'ones_like': 'CLONE',
  'orgqr': 'ALL [2, 1, 2]',
  'pad_sequence': 'CONTIGUOUS',
  'pairwise_distance': 'CONTIGUOUS',
  'pdist': 'ALL [1]',
  'permute': 'PERMUTE',
  'pinverse': 'CONTIGUOUS',
  'poisson': 'CONTIGUOUS',
  'polar': 'STD_PROMOTE',
  'polygamma': 'STD_PROMOTE',
  'polygamma_': 'EQ_FIRST',
  'positive': 'EQ_FIRST',
  'pow.Scalar': 'CONTIGUOUS',
  'pow.Tensor_Scalar': 'STD_PROMOTE',
  'pow.Tensor_Tensor': 'STD_PROMOTE',
  'pow_.Scalar': 'EQ_FIRST',
  'pow_.Tensor': 'EQ_FIRST',
  'prod': 'ALL []',
  'prod.dim_int': 'CONTIGUOUS',
  'quantile.scalar': 'CONTIGUOUS',
  'rad2deg_': 'EQ_FIRST',
  'rand': 'CONTIGUOUS',
  'rand.generator': 'CONTIGUOUS',
  'rand.generator_with_names': 'CONTIGUOUS',
  'rand.names': 'CONTIGUOUS',
  'rand_like': 'CLONE',
  'randint': 'CONTIGUOUS',
  'randint.generator': 'CONTIGUOUS',
  'randint.low': 'CONTIGUOUS',
  'randint.low_generator': 'CONTIGUOUS',
  'randn': 'CONTIGUOUS',
  'randn.generator': 'CONTIGUOUS',
  'randn.generator_with_names': 'CONTIGUOUS',
  'randn.names': 'CONTIGUOUS',
  'randn_like': 'CLONE',
  'random_': 'EQ_FIRST',
  'random_.from': 'EQ_FIRST',
  'random_.to': 'EQ_FIRST',
  'randperm': 'ALL [1]',
  'randperm.generator': 'ALL [1]',
  'randperm.generator_out': 'ALL [1]',
  'randperm.out': 'ALL [1]',
  'range': 'ALL [1]',
  'range.out': 'ALL [1]',
  'range.step': 'ALL [1]',
  'reciprocal': 'STD_PROMOTE',
  'reciprocal_': 'EQ_FIRST',
  'reflection_pad1d': 'CONTIGUOUS',
  'reflection_pad1d.out': 'CONTIGUOUS',
  'reflection_pad1d_backward': 'CONTIGUOUS',
  'reflection_pad2d': 'CONTIGUOUS',
  'reflection_pad2d.out': 'CONTIGUOUS',
  'relu': 'STD_PROMOTE',
  'relu6': 'STD_PROMOTE',
  'relu6_': 'EQ_FIRST',
  'relu_': 'EQ_FIRST',
  'remainder.Scalar': 'CLONE1',
  'remainder.Scalar_Tensor': 'CLONE1',
  'remainder.Tensor': 'STD_PROMOTE',
  'remainder_.Scalar': 'EQ_FIRST',
  'remainder_.Tensor': 'EQ_FIRST',
  'rename': 'EQ_FIRST',
  ...
  'renorm_': 'EQ_FIRST',
  'repeat': 'CONTIGUOUS',
  'repeat_interleave.self_int': 'CONTIGUOUS',
  'replication_pad1d': 'CONTIGUOUS',
  'replication_pad1d.out': 'CONTIGUOUS',
  'replication_pad2d': 'CONTIGUOUS',
  'replication_pad2d.out': 'CONTIGUOUS',
  'requires_grad_': 'EQ_FIRST',
  'reshape_as': 'VIEW',
  'resolve_conj': 'EQ_FIRST',
  'resolve_neg': 'EQ_FIRST',
  'round': 'STD_PROMOTE',
  'round_': 'EQ_FIRST',
  'row_stack': 'CONTIGUOUS',
  'row_stack.out': 'CONTIGUOUS',
  'rrelu': 'CONTIGUOUS',
  'rrelu_': 'EQ_FIRST',
  'rsqrt': 'STD_PROMOTE',
  'rsqrt_': 'EQ_FIRST',
  'rsub.Scalar': 'CLONE1',
  'scalar_tensor': 'ALL []',
  'scatter.src': 'CONTIGUOUS',
  'scatter.value': 'CONTIGUOUS',
  'scatter_.src': 'EQ_FIRST',
  'scatter_.value': 'EQ_FIRST',
  'scatter_add': 'CONTIGUOUS',
  'scatter_add_': 'EQ_FIRST',
  'searchsorted.Tensor': 'CONTIGUOUS',
  'select.int': 'SELECT',
  'select_backward': 'CONTIGUOUS',
  'selu': 'STD_PROMOTE',
  'selu_': 'EQ_FIRST',
  'set_': 'ALL [1]',
  'set_.source_Tensor': 'EQ_SECOND',
  ...
  'sinh_': 'EQ_FIRST',
  'slice.Tensor': 'SLICE',
  'slice_backward': 'CONTIGUOUS',
  'softmax.int': 'CONTIGUOUS',
  'softplus': 'STD_PROMOTE',
  'softplus_backward.grad_input': 'EQ_FIRST',
  'softshrink': 'STD_PROMOTE',
  'softshrink_backward': 'STD_PROMOTE',
  'special_digamma': 'STD_PROMOTE',
  'special_entr': 'STD_PROMOTE',
  'special_erf': 'STD_PROMOTE',
  'special_erfc': 'STD_PROMOTE',
  'special_erfcx': 'STD_PROMOTE',
  'special_erfinv': 'STD_PROMOTE',
  'special_exp2': 'STD_PROMOTE',
  'special_expit': 'STD_PROMOTE',
  'special_expm1': 'STD_PROMOTE',
  'special_gammainc': 'STD_PROMOTE',
  'special_gammaincc': 'STD_PROMOTE',
  'special_gammaln': 'STD_PROMOTE',
  'special_i0': 'STD_PROMOTE',
  'special_i0e': 'STD_PROMOTE',
  'special_i1': 'STD_PROMOTE',
  'special_i1e': 'STD_PROMOTE',
  'special_log1p': 'STD_PROMOTE',
  'special_log_softmax': 'CONTIGUOUS',
  'special_logit': 'STD_PROMOTE',
  'special_logsumexp': 'CONTIGUOUS',
  'special_multigammaln': 'CONTIGUOUS',
  'special_ndtri': 'STD_PROMOTE',
  'special_polygamma': 'STD_PROMOTE',
  'special_psi': 'STD_PROMOTE',
  'special_round': 'STD_PROMOTE',
  'special_sinc': 'STD_PROMOTE',
  'special_softmax': 'CONTIGUOUS',
  'special_xlog1py': 'STD_PROMOTE',
  'special_xlog1py.other_scalar': 'CLONE1',
  'special_xlog1py.self_scalar': 'CLONE1',
  'special_xlogy': 'STD_PROMOTE',
  'special_xlogy.other_scalar': 'CLONE1',
  'special_xlogy.self_scalar': 'CLONE1',
  'special_zeta': 'STD_PROMOTE',
  'special_zeta.other_scalar': 'CLONE1',
  'special_zeta.self_scalar': 'CLONE1',
  'sqrt': 'STD_PROMOTE',
  'sqrt_': 'EQ_FIRST',
  'square': 'STD_PROMOTE',
  'square_': 'EQ_FIRST',
  'stack': 'CONTIGUOUS',
  'std': 'ALL []',
  'std.correction': 'CONTIGUOUS',
  'std.correction_out': 'CONTIGUOUS',
  'std.dim': 'CONTIGUOUS',
  'sub.Scalar': 'CLONE1',
  'sub.Tensor': 'STD_PROMOTE',
  'sub_.Scalar': 'EQ_FIRST',
  'sub_.Tensor': 'EQ_FIRST',
  'subtract.Scalar': 'CLONE1',
  'subtract.Tensor': 'STD_PROMOTE',
  'subtract_.Scalar': 'EQ_FIRST',
  'subtract_.Tensor': 'EQ_FIRST',
  'sum': 'ALL []',
  'sum.dim_IntList': 'CONTIGUOUS',
  'swapaxes': 'TRANSPOSE',
  'swapaxes_': 'TRANSPOSE',
  'swapdims': 'TRANSPOSE',
  'swapdims_': 'TRANSPOSE',
  't': 'TRANSPOSE2D',
  't_': 'TRANSPOSE2D',
  'take_along_dim': 'ALL [1]',
  'take_along_dim.out': 'ALL [1]',
  'tan': 'STD_PROMOTE',
  'tan_': 'EQ_FIRST',
  'tanh': 'STD_PROMOTE',
  'tanh_': 'EQ_FIRST',
  'tanh_backward': 'STD_PROMOTE',
  'tensordot': 'CONTIGUOUS',
  'thnn_conv2d': 'CONTIGUOUS',
  'thnn_conv2d.out': 'CONTIGUOUS',
  'threshold': 'STD_PROMOTE',
  'threshold_': 'EQ_FIRST',
  'tile': 'CONTIGUOUS',
  'to.device': 'CLONE2',
  'to.dtype': 'CLONE2',
  'to.dtype_layout': 'CLONE2',
  'trace': 'ALL []',
  'transpose.int': 'TRANSPOSE',
  'transpose_': 'TRANSPOSE',
  'trapezoid.dx': 'CONTIGUOUS',
  'trapezoid.x': 'CONTIGUOUS',
  'trapz.dx': 'CONTIGUOUS',
  'trapz.x': 'CONTIGUOUS',
  'tril': 'CONTIGUOUS',
  'tril_': 'EQ_FIRST',
  'tril_indices': 'CONTIGUOUS',
  'triplet_margin_loss': 'CONTIGUOUS',
  'triu': 'CONTIGUOUS',
  'triu_': 'EQ_FIRST',
  'triu_indices': 'CONTIGUOUS',
  'true_divide.Scalar': 'CLONE1',
  'true_divide.Tensor': 'STD_PROMOTE',
  'true_divide_.Scalar': 'EQ_FIRST',
  'true_divide_.Tensor': 'EQ_FIRST',
  'trunc': 'STD_PROMOTE',
  ...
  'unsqueeze': 'UNSQUEEZE',
  'unsqueeze_': 'UNSQUEEZE',
  'upsample_bicubic2d': 'CONTIGUOUS',
  'upsample_bicubic2d.out': 'CONTIGUOUS',
  'upsample_bilinear2d': 'CONTIGUOUS',
  'upsample_bilinear2d.out': 'CONTIGUOUS',
  'upsample_nearest2d': 'CONTIGUOUS',
  'upsample_nearest2d.out': 'CONTIGUOUS',
  'value_selecting_reduction_backward': 'CONTIGUOUS',
  'var': 'ALL []',
  'var.correction': 'CONTIGUOUS',
  'var.correction_out': 'CONTIGUOUS',
  'var.dim': 'CONTIGUOUS',
  'view': 'VIEW',
  'view.dtype': 'EQ_FIRST',
  'view_as': 'VIEW',
  'view_as_complex': 'ALL [1]',
  'vstack': 'CONTIGUOUS',
  'vstack.out': 'CONTIGUOUS',
  'where.Scalar': 'CONTIGUOUS',
  'where.self': 'CONTIGUOUS',
  'xlogy.Scalar_Other': 'CLONE1',
  'xlogy.Scalar_Self': 'CLONE1',
  'xlogy.Tensor': 'STD_PROMOTE',
  'xlogy_.Scalar_Other': 'EQ_FIRST',
  'xlogy_.Tensor': 'EQ_FIRST',
  'zero_': 'EQ_FIRST',
  'zeros': 'CONTIGUOUS',
  'zeros.names': 'CONTIGUOUS',
  'zeros_like': 'CLONE',
}
