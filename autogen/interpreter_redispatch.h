...
case H_CHOLESKY_INVERSE:
  set(op, redispatch_ptrs_0[op.id - H__CAST_BYTE](ks, load<at::Tensor &>()(op.args[0]), load<bool>()(op.args[1])));
  continue;
...
case H_LINALG_SVDVALS:
  set(op, redispatch_ptrs_1[op.id - H_DATA](ks, load<at::Tensor &>()(op.args[0])));
  continue;
...
case H_LINALG_MATRIX_POWER:
  set(op, redispatch_ptrs_2[op.id - H__FW_PRIMAL](ks, load<at::Tensor &>()(op.args[0]), load<int64_t>()(op.args[1])));
  continue;
...
case H_GLU_BACKWARD:
  set(op, redispatch_ptrs_3[op.id - H__MAKE_DUAL](ks, load<at::Tensor &>()(op.args[0]), load<at::Tensor &>()(op.args[1]), load<int64_t>()(op.args[2])));
  continue;
...
case H_GER:
case H_LINALG_SOLVE:
  set(op, redispatch_ptrs_4[op.id - H_ALIGN_AS](ks, load<at::Tensor &>()(op.args[0]), load<at::Tensor &>()(op.args[1])));
  continue;
...
case H_LINALG_PINV:
  set(op, redispatch_ptrs_6[op.id - H_DROPOUT](ks, load<at::Tensor &>()(op.args[0]), load<double>()(op.args[1]), load<bool>()(op.args[2])));
  continue;
...
case H_LINALG_SVDVALS_OUT:
  init_update_in_place(op);
  redispatch_ptrs_9[op.id - H_ABS_OUT](ks, load<at::Tensor &>()(op.args[0]), load<at::Tensor &>()(op.args[1]));
  break;
...
case H_REFLECTION_PAD2D:
  set(op, redispatch_ptrs_10[op.id - H_ADAPTIVE_AVG_POOL1D](ks, load<at::Tensor &>()(op.args[0]), load<at::IntArrayRef>()(op.args[1])));
  continue;
...
case H__TEST_SERIALIZATION_SUBCMUL:
  set(op, redispatch_ptrs_11[op.id - H_ADD_TENSOR](ks, load<at::Tensor &>()(op.args[0]), load<at::Tensor &>()(op.args[1]), load<at::Scalar &>()(op.args[2])));
  continue;
...
case H_LERP__SCALAR:
  init_update_in_place(op);
  redispatch_ptrs_12[op.id - H_ADD__TENSOR](ks, load<at::Tensor &>()(op.args[0]), load<at::Tensor &>()(op.args[1]), load<at::Scalar &>()(op.args[2]));
  break;
...
case H_SOFTSHRINK_BACKWARD_GRAD_INPUT:
  init_update_in_place(op);
  redispatch_ptrs_13[op.id - H_ADD_OUT](ks, load<at::Tensor &>()(op.args[0]), load<at::Tensor &>()(op.args[1]), load<at::Scalar &>()(op.args[2]), load<at::Tensor &>()(op.args[3]));
  break;
...
case H_RSUB_SCALAR:
case H_HARDTANH:
  set(op, redispatch_ptrs_14[op.id - H_ADD_SCALAR](ks, load<at::Tensor &>()(op.args[0]), load<at::Scalar &>()(op.args[1]), load<at::Scalar &>()(op.args[2])));
  continue;
...
case H_HARDTANH_:
  init_update_in_place(op);
  redispatch_ptrs_15[op.id - H_ADD__SCALAR](ks, load<at::Tensor &>()(op.args[0]), load<at::Scalar &>()(op.args[1]), load<at::Scalar &>()(op.args[2]));
  break;
...
case H_ADDBMM_OUT:
  init_update_in_place(op);
  redispatch_ptrs_16[op.id - H_ADDMV_OUT](ks, load<at::Tensor &>()(op.args[0]), load<at::Tensor &>()(op.args[1]), load<at::Tensor &>()(op.args[2]), load<at::Scalar &>()(op.args[3]), load<at::Scalar &>()(op.args[4]), load<at::Tensor &>()(op.args[5]));
  break;
...
case H_ADDMM:
case H_ADDBMM:
  set(op, redispatch_ptrs_17[op.id - H_ADDR](ks, load<at::Tensor &>()(op.args[0]), load<at::Tensor &>()(op.args[1]), load<at::Tensor &>()(op.args[2]), load<at::Scalar &>()(op.args[3]), load<at::Scalar &>()(op.args[4])));
  continue;
...
case H_ADDBMM_:
  init_update_in_place(op);
  redispatch_ptrs_18[op.id - H_ADDR_](ks, load<at::Tensor &>()(op.args[0]), load<at::Tensor &>()(op.args[1]), load<at::Tensor &>()(op.args[2]), load<at::Scalar &>()(op.args[3]), load<at::Scalar &>()(op.args[4]));
  break;
...
case H_NUCLEAR_NORM_DIM:
  set(op, redispatch_ptrs_19[op.id - H_AFFINE_GRID_GENERATOR](ks, load<at::Tensor &>()(op.args[0]), load<at::IntArrayRef>()(op.args[1]), load<bool>()(op.args[2])));
  continue;
...
case H_COMBINATIONS:
case H_ARGSORT:
  set(op, redispatch_ptrs_20[op.id - H_ALL_DIM](ks, load<at::Tensor &>()(op.args[0]), load<int64_t>()(op.args[1]), load<bool>()(op.args[2])));
  continue;
...
case H_ARGSORT_DIMNAME:
  set(op, redispatch_ptrs_21[op.id - H_ALL_DIMNAME](ks, load<at::Tensor &>()(op.args[0]), load<at::Dimname>()(op.args[1]), load<bool>()(op.args[2])));
  continue;
...
case H_ARGMIN:
case H_VANDER:
  set(op, redispatch_ptrs_22[op.id - H_ARGMAX](ks, load<at::Tensor &>()(op.args[0]), load<c10::optional<int64_t>>()(op.args[1]), load<bool>()(op.args[2])));
  continue;
...
case H_POISSON:
  set(op, redispatch_ptrs_25[op.id - H_BERNOULLI](ks, load<at::Tensor &>()(op.args[0]), load<c10::optional<at::Generator>>()(op.args[1])));
  continue;
...
case H_LINALG_SOLVE_OUT:
  init_update_in_place(op);
  redispatch_ptrs_27[op.id - H_COPYSIGN_OUT](ks, load<at::Tensor &>()(op.args[0]), load<at::Tensor &>()(op.args[1]), load<at::Tensor &>()(op.args[2]));
  break;
...
case H_SPECIAL_XLOG1PY_OTHER_SCALAR:
  set(op, redispatch_ptrs_28[op.id - H_COPYSIGN_SCALAR](ks, load<at::Tensor &>()(op.args[0]), load<at::Scalar &>()(op.args[1])));
  continue;
...
case H_LEAKY_RELU_:
  init_update_in_place(op);
  redispatch_ptrs_29[op.id - H_COPYSIGN__SCALAR](ks, load<at::Tensor &>()(op.args[0]), load<at::Scalar &>()(op.args[1]));
  break;
...
case H_SPECIAL_XLOG1PY_OTHER_SCALAR_OUT:
  init_update_in_place(op);
  redispatch_ptrs_30[op.id - H_COPYSIGN_SCALAR_OUT](ks, load<at::Tensor &>()(op.args[0]), load<at::Scalar &>()(op.args[1]), load<at::Tensor &>()(op.args[2]));
  break;
...
case H_FLOAT_POWER__TENSOR:
  init_update_in_place(op);
  redispatch_ptrs_31[op.id - H_LOGICAL_XOR_](ks, load<at::Tensor &>()(op.args[0]), load<at::Tensor &>()(op.args[1]));
  break;
...
case H_LINALG_MATRIX_RANK_TOL_TENSOR:
  set(op, redispatch_ptrs_32[op.id - H__BMM](ks, load<at::Tensor &>()(op.args[0]), load<at::Tensor &>()(op.args[1]), load<bool>()(op.args[2])));
  continue;
...
case H_LINALG_MATRIX_RANK_OUT_TOL_TENSOR:
  init_update_in_place(op);
  redispatch_ptrs_33[op.id - H__BMM_OUT](ks, load<at::Tensor &>()(op.args[0]), load<at::Tensor &>()(op.args[1]), load<bool>()(op.args[2]), load<at::Tensor &>()(op.args[3]));
  break;
...
case H_CONV3D_PADDING:
  set(op, redispatch_ptrs_38[op.id - H__CONVOLUTION_MODE](ks, load<at::Tensor &>()(op.args[0]), load<at::Tensor &>()(op.args[1]), load<c10::optional<at::Tensor> &>()(op.args[2]), load<at::IntArrayRef>()(op.args[3]), load<c10::string_view>()(op.args[4]), load<at::IntArrayRef>()(op.args[5]), load<int64_t>()(op.args[6])));
  continue;
...
case H_MKLDNN_CONVOLUTION:
  set(op, redispatch_ptrs_39[op.id - H_CONV1D](ks, load<at::Tensor &>()(op.args[0]), load<at::Tensor &>()(op.args[1]), load<c10::optional<at::Tensor> &>()(op.args[2]), load<at::IntArrayRef>()(op.args[3]), load<at::IntArrayRef>()(op.args[4]), load<at::IntArrayRef>()(op.args[5]), load<int64_t>()(op.args[6])));
  continue;
...
case H_SOFT_MARGIN_LOSS_BACKWARD:
  set(op, redispatch_ptrs_40[op.id - H_CONV_TBC](ks, load<at::Tensor &>()(op.args[0]), load<at::Tensor &>()(op.args[1]), load<at::Tensor &>()(op.args[2]), load<int64_t>()(op.args[3])));
  continue;

case H_CONV_TRANSPOSE1D:
case H_CONV_TRANSPOSE2D_INPUT:
case H_CONV_TRANSPOSE3D_INPUT:
  set(op, redispatch_ptrs_41[op.id - H_CONV_TRANSPOSE1D](ks, load<at::Tensor &>()(op.args[0]), load<at::Tensor &>()(op.args[1]), load<c10::optional<at::Tensor> &>()(op.args[2]), load<at::IntArrayRef>()(op.args[3]), load<at::IntArrayRef>()(op.args[4]), load<at::IntArrayRef>()(op.args[5]), load<int64_t>()(op.args[6]), load<at::IntArrayRef>()(op.args[7])));
  continue;
...
case H__SPARSE_LOG_SOFTMAX_INT:
  set(op, redispatch_ptrs_44[op.id - H_CUMPROD](ks, load<at::Tensor &>()(op.args[0]), load<int64_t>()(op.args[1]), load<c10::optional<at::ScalarType>>()(op.args[2])));
  continue;
...
case H__SPARSE_LOG_SOFTMAX_DIMNAME:
  set(op, redispatch_ptrs_45[op.id - H_CUMPROD_DIMNAME](ks, load<at::Tensor &>()(op.args[0]), load<at::Dimname>()(op.args[1]), load<c10::optional<at::ScalarType>>()(op.args[2])));
  continue;
...
case H__SPARSE_LOG_SOFTMAX_BACKWARD_DATA:
  set(op, redispatch_ptrs_46[op.id - H_CUMPROD_BACKWARD](ks, load<at::Tensor &>()(op.args[0]), load<at::Tensor &>()(op.args[1]), load<int64_t>()(op.args[2]), load<at::Tensor &>()(op.args[3])));
  continue;
...
case H__REMOVE_BATCH_DIM:
  set(op, redispatch_ptrs_47[op.id - H_DIAG_EMBED](ks, load<at::Tensor &>()(op.args[0]), load<int64_t>()(op.args[1]), load<int64_t>()(op.args[2]), load<int64_t>()(op.args[3])));
  continue;
...
case H_GRID_SAMPLER_3D:
  set(op, redispatch_ptrs_48[op.id - H_EMBEDDING_DENSE_BACKWARD](ks, load<at::Tensor &>()(op.args[0]), load<at::Tensor &>()(op.args[1]), load<int64_t>()(op.args[2]), load<int64_t>()(op.args[3]), load<bool>()(op.args[4])));
  continue;
...
case H_NEW_ZEROS:
case H_NEW_ONES:
  set(op, redispatch_ptrs_49[op.id - H_NEW_EMPTY](ks, load<at::Tensor &>()(op.args[0]), load<at::IntArrayRef>()(op.args[1]), load<c10::optional<at::ScalarType>>()(op.args[2]), load<c10::optional<at::Layout>>()(op.args[3]), load<c10::optional<at::Device>>()(op.args[4]), load<c10::optional<bool>>()(op.args[5])));
  continue;
...
case H_RANDN_LIKE:
case H_ZEROS_LIKE:
  set(op, redispatch_ptrs_50[op.id - H_EMPTY_LIKE](ks, load<at::Tensor &>()(op.args[0]), load<c10::optional<at::ScalarType>>()(op.args[1]), load<c10::optional<at::Layout>>()(op.args[2]), load<c10::optional<at::Device>>()(op.args[3]), load<c10::optional<bool>>()(op.args[4]), load<c10::optional<at::MemoryFormat>>()(op.args[5])));
  continue;
...
case H__TEST_AMBIGUOUS_DEFAULTS_A:
  set(op, redispatch_ptrs_51[op.id - H_FLATTEN_USING_INTS](ks, load<at::Tensor &>()(op.args[0]), load<int64_t>()(op.args[1]), load<int64_t>()(op.args[2])));
  continue;
...
case H__INDEX_COPY_:
  init_update_in_place(op);
  redispatch_ptrs_52[op.id - H_INDEX_COPY_](ks, load<at::Tensor &>()(op.args[0]), load<int64_t>()(op.args[1]), load<at::Tensor &>()(op.args[2]), load<at::Tensor &>()(op.args[3]));
  break;
...
case H__GATHER_SPARSE_BACKWARD:
  set(op, redispatch_ptrs_53[op.id - H_INDEX_COPY](ks, load<at::Tensor &>()(op.args[0]), load<int64_t>()(op.args[1]), load<at::Tensor &>()(op.args[2]), load<at::Tensor &>()(op.args[3])));
  continue;
...
case H_SCATTER_ADD_DIMNAME:
  set(op, redispatch_ptrs_54[op.id - H_INDEX_COPY_DIMNAME](ks, load<at::Tensor &>()(op.args[0]), load<at::Dimname>()(op.args[1]), load<at::Tensor &>()(op.args[2]), load<at::Tensor &>()(op.args[3])));
  continue;
