TORCH_LIBRARY_IMPL(aten, DISPATCHKEY_NO_NS, m) {
  ...
  m.impl("_cholesky_helper", wrap__cholesky_helper);
  ...
  m.impl("_lstsq_helper_", wrap__lstsq_helper_);
