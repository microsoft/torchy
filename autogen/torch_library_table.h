...
m.impl("_new_zeros_with_same_feature_meta", wrap__new_zeros_with_same_feature_meta);
...
m.impl("native_dropout", wrap_native_dropout);
m.impl("native_dropout_backward", wrap_native_dropout_backward);
...
m.impl("resolve_neg", wrap_resolve_neg);
m.impl("_neg_view", wrap__neg_view);
m.impl("acos", wrap_acos);
m.impl("acos_", wrap_acos_);
...
m.impl("_add_relu.Scalar", wrap__add_relu_Scalar);
m.impl("_add_relu_.Scalar", wrap__add_relu__Scalar);
m.impl("add.Scalar", wrap_add_Scalar);
m.impl("add_.Scalar", wrap_add__Scalar);
m.impl("addmv", wrap_addmv);
m.impl("addmv_", wrap_addmv_);
...
m.impl("acosh", wrap_acosh);
m.impl("acosh_", wrap_acosh_);
...
m.impl("asinh", wrap_asinh);
m.impl("asinh_", wrap_asinh_);
...
m.impl("atanh", wrap_atanh);
m.impl("atanh_", wrap_atanh_);
...
m.impl("atan", wrap_atan);
m.impl("atan_", wrap_atan_);
...
m.impl("bitwise_not", wrap_bitwise_not);
m.impl("bitwise_not_", wrap_bitwise_not_);
m.impl("bitwise_not.out", wrap_bitwise_not_out);
m.impl("copysign.out", wrap_copysign_out);
m.impl("copysign.Tensor", wrap_copysign_Tensor);
m.impl("copysign_.Tensor", wrap_copysign__Tensor);
...
m.impl("concat", wrap_concat);
m.impl("concat.out", wrap_concat_out);
m.impl("concat.names", wrap_concat_names);
m.impl("concat.names_out", wrap_concat_names_out);
...
m.impl("_copy_from", wrap__copy_from);
m.impl("_copy_from_and_resize", wrap__copy_from_and_resize);
m.impl("cos", wrap_cos);
m.impl("cos_", wrap_cos_);
m.impl("cos.out", wrap_cos_out);
m.impl("cosh", wrap_cosh);
m.impl("cosh_", wrap_cosh_);
...
m.impl("cumulative_trapezoid.x", wrap_cumulative_trapezoid_x);
m.impl("cumulative_trapezoid.dx", wrap_cumulative_trapezoid_dx);
...
m.impl("erf", wrap_erf);
m.impl("erf_", wrap_erf_);
m.impl("erf.out", wrap_erf_out);
m.impl("erfc", wrap_erfc);
m.impl("erfc_", wrap_erfc_);
m.impl("erfc.out", wrap_erfc_out);
m.impl("exp", wrap_exp);
m.impl("exp_", wrap_exp_);
m.impl("exp.out", wrap_exp_out);
m.impl("exp2", wrap_exp2);
m.impl("exp2_", wrap_exp2_);
m.impl("exp2.out", wrap_exp2_out);
m.impl("expm1", wrap_expm1);
m.impl("expm1_", wrap_expm1_);
...
m.impl("frac", wrap_frac);
m.impl("frac_", wrap_frac_);
...
m.impl("gcd", wrap_gcd);
m.impl("gcd_", wrap_gcd_);
m.impl("lcm.out", wrap_lcm_out);
m.impl("lcm", wrap_lcm);
m.impl("lcm_", wrap_lcm_);
...
m.impl("isin.Tensor_Tensor_out", wrap_isin_Tensor_Tensor_out);
m.impl("isin.Tensor_Tensor", wrap_isin_Tensor_Tensor);
m.impl("isin.Tensor_Scalar_out", wrap_isin_Tensor_Scalar_out);
m.impl("isin.Tensor_Scalar", wrap_isin_Tensor_Scalar);
m.impl("isin.Scalar_Tensor_out", wrap_isin_Scalar_Tensor_out);
m.impl("isin.Scalar_Tensor", wrap_isin_Scalar_Tensor);
...
m.impl("linear.out", wrap_linear_out);
...
m.impl("_log_softmax.out", wrap__log_softmax_out);
m.impl("_log_softmax_backward_data", wrap__log_softmax_backward_data);
m.impl("_log_softmax_backward_data.out", wrap__log_softmax_backward_data_out);
...
m.impl("aminmax", wrap_aminmax);
m.impl("aminmax.out", wrap_aminmax_out);
...
m.impl("nanmean", wrap_nanmean);
m.impl("nanmean.out", wrap_nanmean_out);
...
m.impl("mvlgamma.out", wrap_mvlgamma_out);
...
m.impl("matrix_H", wrap_matrix_H);
m.impl("mT", wrap_mT);
m.impl("mH", wrap_mH);
m.impl("adjoint", wrap_adjoint);
...
m.impl("_pin_memory", wrap__pin_memory);
...
m.impl("reciprocal", wrap_reciprocal);
m.impl("reciprocal_", wrap_reciprocal_);
...
m.impl("_reshape_alias", wrap__reshape_alias);
m.impl("_mkldnn_reshape", wrap__mkldnn_reshape);
m.impl("reshape_as", wrap_reshape_as);
m.impl("round", wrap_round);
m.impl("round_", wrap_round_);
...
m.impl("gelu_backward", wrap_gelu_backward);
...
m.impl("hardshrink", wrap_hardshrink);
m.impl("hardshrink_backward.grad_input", wrap_hardshrink_backward_grad_input);
m.impl("hardshrink_backward", wrap_hardshrink_backward);
m.impl("rsqrt", wrap_rsqrt);
m.impl("rsqrt_", wrap_rsqrt_);
...
m.impl("silu_backward.grad_input", wrap_silu_backward_grad_input);
...
m.impl("sin", wrap_sin);
m.impl("sin_", wrap_sin_);
m.impl("sin.out", wrap_sin_out);
m.impl("sinc", wrap_sinc);
m.impl("sinc_", wrap_sinc_);
m.impl("sinc.out", wrap_sinc_out);
m.impl("sinh", wrap_sinh);
m.impl("sinh_", wrap_sinh_);
...
m.impl("slice_scatter", wrap_slice_scatter);
m.impl("select_scatter", wrap_select_scatter);
m.impl("diagonal_scatter", wrap_diagonal_scatter);
...
m.impl("_softmax.out", wrap__softmax_out);
m.impl("_softmax_backward_data", wrap__softmax_backward_data);
m.impl("_softmax_backward_data.out", wrap__softmax_backward_data_out);
...
m.impl("threshold_", wrap_threshold_);
...
m.impl("trapezoid.x", wrap_trapezoid_x);
m.impl("trapezoid.dx", wrap_trapezoid_dx);
...
m.impl("heaviside", wrap_heaviside);
m.impl("heaviside_", wrap_heaviside_);
...
m.impl("quantize_per_tensor_dynamic", wrap_quantize_per_tensor_dynamic);
m.impl("quantize_per_tensor", wrap_quantize_per_tensor);
m.impl("quantize_per_tensor.tensor_qparams", wrap_quantize_per_tensor_tensor_qparams);
...
m.impl("fake_quantize_per_tensor_affine.tensor_qparams", wrap_fake_quantize_per_tensor_affine_tensor_qparams);
m.impl("fake_quantize_per_tensor_affine_cachemask", wrap_fake_quantize_per_tensor_affine_cachemask);
m.impl("_fake_quantize_per_tensor_affine_cachemask_tensor_qparams", wrap__fake_quantize_per_tensor_affine_cachemask_tensor_qparams);
...
m.impl("fused_moving_avg_obs_fake_quant", wrap_fused_moving_avg_obs_fake_quant);
m.impl("_fused_moving_avg_obs_fq_helper", wrap__fused_moving_avg_obs_fq_helper);
...
m.impl("_autocast_to_reduced_precision", wrap__autocast_to_reduced_precision);
m.impl("_autocast_to_full_precision", wrap__autocast_to_full_precision);
m.impl("_to_copy", wrap__to_copy);
...
m.impl("meshgrid.indexing", wrap_meshgrid_indexing);
...
m.impl("scatter.src", wrap_scatter_src);
m.impl("scatter_.src", wrap_scatter__src);
m.impl("scatter.src_out", wrap_scatter_src_out);
m.impl("scatter.value", wrap_scatter_value);
m.impl("scatter_.value", wrap_scatter__value);
m.impl("scatter.value_out", wrap_scatter_value_out);
m.impl("scatter.reduce", wrap_scatter_reduce);
m.impl("scatter_.reduce", wrap_scatter__reduce);
m.impl("scatter.reduce_out", wrap_scatter_reduce_out);
m.impl("scatter.value_reduce", wrap_scatter_value_reduce);
m.impl("scatter_.value_reduce", wrap_scatter__value_reduce);
...
m.impl("scatter_add", wrap_scatter_add);
m.impl("scatter_add_", wrap_scatter_add_);
m.impl("scatter_add.out", wrap_scatter_add_out);
m.impl("scatter_add.dimname", wrap_scatter_add_dimname);
m.impl("_scatter_reduce", wrap__scatter_reduce);
m.impl("_scatter_reduce.out", wrap__scatter_reduce_out);
...
m.impl("bitwise_left_shift.Tensor", wrap_bitwise_left_shift_Tensor);
m.impl("bitwise_left_shift_.Tensor", wrap_bitwise_left_shift__Tensor);
m.impl("bitwise_left_shift.Tensor_out", wrap_bitwise_left_shift_Tensor_out);
m.impl("bitwise_left_shift.Tensor_Scalar", wrap_bitwise_left_shift_Tensor_Scalar);
m.impl("bitwise_left_shift_.Tensor_Scalar", wrap_bitwise_left_shift__Tensor_Scalar);
m.impl("bitwise_left_shift.Tensor_Scalar_out", wrap_bitwise_left_shift_Tensor_Scalar_out);
m.impl("bitwise_left_shift.Scalar_Tensor", wrap_bitwise_left_shift_Scalar_Tensor);
...
m.impl("bitwise_right_shift.Tensor", wrap_bitwise_right_shift_Tensor);
m.impl("bitwise_right_shift_.Tensor", wrap_bitwise_right_shift__Tensor);
m.impl("bitwise_right_shift.Tensor_out", wrap_bitwise_right_shift_Tensor_out);
m.impl("bitwise_right_shift.Tensor_Scalar", wrap_bitwise_right_shift_Tensor_Scalar);
m.impl("bitwise_right_shift_.Tensor_Scalar", wrap_bitwise_right_shift__Tensor_Scalar);
m.impl("bitwise_right_shift.Tensor_Scalar_out", wrap_bitwise_right_shift_Tensor_Scalar_out);
m.impl("bitwise_right_shift.Scalar_Tensor", wrap_bitwise_right_shift_Scalar_Tensor);
m.impl("tril_", wrap_tril_);
m.impl("triu_", wrap_triu_);
m.impl("digamma_", wrap_digamma_);
...
m.impl("linalg_solve_triangular.out", wrap_linalg_solve_triangular_out);
m.impl("linalg_solve_triangular", wrap_linalg_solve_triangular);
...
m.impl("atan2_", wrap_atan2_);
m.impl("atan2", wrap_atan2);
m.impl("arctan2", wrap_arctan2);
m.impl("arctan2.out", wrap_arctan2_out);
m.impl("arctan2_", wrap_arctan2_);
...
m.impl("histogram.bins_tensor_out", wrap_histogram_bins_tensor_out);
m.impl("histogram.bins_tensor", wrap_histogram_bins_tensor);
m.impl("histogram.bin_ct_out", wrap_histogram_bin_ct_out);
m.impl("histogram.bin_ct", wrap_histogram_bin_ct);
m.impl("_histogramdd_bin_edges", wrap__histogramdd_bin_edges);
m.impl("_histogramdd_from_bin_cts", wrap__histogramdd_from_bin_cts);
m.impl("_histogramdd_from_bin_tensors", wrap__histogramdd_from_bin_tensors);
...
m.impl("hypot", wrap_hypot);
m.impl("hypot_", wrap_hypot_);
m.impl("igamma.out", wrap_igamma_out);
m.impl("igamma", wrap_igamma);
m.impl("igamma_", wrap_igamma_);
m.impl("igammac.out", wrap_igammac_out);
m.impl("igammac", wrap_igammac);
m.impl("igammac_", wrap_igammac_);
m.impl("nextafter.out", wrap_nextafter_out);
m.impl("nextafter", wrap_nextafter);
...
m.impl("all", wrap_all);
m.impl("all.all_out", wrap_all_all_out);
m.impl("any", wrap_any);
m.impl("any.all_out", wrap_any_all_out);
m.impl("renorm.out", wrap_renorm_out);
m.impl("renorm", wrap_renorm);
m.impl("renorm_", wrap_renorm_);
...
m.impl("pow.Tensor_Tensor", wrap_pow_Tensor_Tensor);
m.impl("pow.Scalar_out", wrap_pow_Scalar_out);
m.impl("pow.Scalar", wrap_pow_Scalar);
m.impl("pow.Tensor_Scalar_out", wrap_pow_Tensor_Scalar_out);
m.impl("pow.Tensor_Scalar", wrap_pow_Tensor_Scalar);
m.impl("pow_.Scalar", wrap_pow__Scalar);
m.impl("pow_.Tensor", wrap_pow__Tensor);
...
m.impl("_foreach_norm.Scalar", wrap__foreach_norm_Scalar);
...
m.impl("_torch_cuda_cu_linker_symbol_op", wrap__torch_cuda_cu_linker_symbol_op);
m.impl("searchsorted.Tensor_out", wrap_searchsorted_Tensor_out);
m.impl("searchsorted.Scalar", wrap_searchsorted_Scalar);
m.impl("_convert_indices_from_coo_to_csr", wrap__convert_indices_from_coo_to_csr);
m.impl("_convert_indices_from_coo_to_csr.out", wrap__convert_indices_from_coo_to_csr_out);
m.impl("_convert_indices_from_csr_to_coo", wrap__convert_indices_from_csr_to_coo);
m.impl("_convert_indices_from_csr_to_coo.out", wrap__convert_indices_from_csr_to_coo_out);
...
m.impl("elu_backward", wrap_elu_backward);
...
m.impl("hardsigmoid_", wrap_hardsigmoid_);
m.impl("hardsigmoid_backward.grad_input", wrap_hardsigmoid_backward_grad_input);
m.impl("hardsigmoid_backward", wrap_hardsigmoid_backward);
...
m.impl("leaky_relu_backward", wrap_leaky_relu_backward);
...
m.impl("fractional_max_pool2d", wrap_fractional_max_pool2d);
...
m.impl("max_pool2d_with_indices", wrap_max_pool2d_with_indices);
m.impl("max_pool2d_with_indices_backward.grad_input", wrap_max_pool2d_with_indices_backward_grad_input);
m.impl("max_pool2d_with_indices_backward", wrap_max_pool2d_with_indices_backward);
...
m.impl("reflection_pad1d_backward", wrap_reflection_pad1d_backward);
...
m.impl("reflection_pad3d.out", wrap_reflection_pad3d_out);
m.impl("reflection_pad3d", wrap_reflection_pad3d);
m.impl("reflection_pad3d_backward.grad_input", wrap_reflection_pad3d_backward_grad_input);
m.impl("reflection_pad3d_backward", wrap_reflection_pad3d_backward);
m.impl("replication_pad1d.out", wrap_replication_pad1d_out);
m.impl("replication_pad1d", wrap_replication_pad1d);
m.impl("replication_pad1d_backward.grad_input", wrap_replication_pad1d_backward_grad_input);
m.impl("replication_pad1d_backward", wrap_replication_pad1d_backward);
m.impl("replication_pad2d.out", wrap_replication_pad2d_out);
m.impl("replication_pad2d", wrap_replication_pad2d);
...
m.impl("replication_pad3d", wrap_replication_pad3d);
...
m.impl("_upsample_bilinear2d_aa.vec", wrap__upsample_bilinear2d_aa_vec);
m.impl("_upsample_bilinear2d_aa_backward.vec", wrap__upsample_bilinear2d_aa_backward_vec);
...
m.impl("_upsample_nearest_exact1d.vec", wrap__upsample_nearest_exact1d_vec);
m.impl("upsample_nearest1d_backward.vec", wrap_upsample_nearest1d_backward_vec);
m.impl("_upsample_nearest_exact1d_backward.vec", wrap__upsample_nearest_exact1d_backward_vec);
m.impl("upsample_nearest2d.vec", wrap_upsample_nearest2d_vec);
m.impl("_upsample_nearest_exact2d.vec", wrap__upsample_nearest_exact2d_vec);
m.impl("upsample_nearest2d_backward.vec", wrap_upsample_nearest2d_backward_vec);
m.impl("_upsample_nearest_exact2d_backward.vec", wrap__upsample_nearest_exact2d_backward_vec);
m.impl("upsample_nearest3d.vec", wrap_upsample_nearest3d_vec);
m.impl("_upsample_nearest_exact3d.vec", wrap__upsample_nearest_exact3d_vec);
m.impl("upsample_nearest3d_backward.vec", wrap_upsample_nearest3d_backward_vec);
m.impl("_upsample_nearest_exact3d_backward.vec", wrap__upsample_nearest_exact3d_backward_vec);
m.impl("upsample_linear1d.out", wrap_upsample_linear1d_out);
m.impl("upsample_linear1d", wrap_upsample_linear1d);
m.impl("upsample_linear1d_backward.grad_input", wrap_upsample_linear1d_backward_grad_input);
m.impl("upsample_linear1d_backward", wrap_upsample_linear1d_backward);
...
m.impl("upsample_bilinear2d_backward", wrap_upsample_bilinear2d_backward);
m.impl("_upsample_bilinear2d_aa.out", wrap__upsample_bilinear2d_aa_out);
m.impl("_upsample_bilinear2d_aa", wrap__upsample_bilinear2d_aa);
m.impl("_upsample_bilinear2d_aa_backward.grad_input", wrap__upsample_bilinear2d_aa_backward_grad_input);
m.impl("_upsample_bilinear2d_aa_backward", wrap__upsample_bilinear2d_aa_backward);
m.impl("upsample_bicubic2d.out", wrap_upsample_bicubic2d_out);
m.impl("upsample_bicubic2d", wrap_upsample_bicubic2d);
m.impl("upsample_bicubic2d_backward.grad_input", wrap_upsample_bicubic2d_backward_grad_input);
m.impl("upsample_bicubic2d_backward", wrap_upsample_bicubic2d_backward);
m.impl("upsample_trilinear3d.out", wrap_upsample_trilinear3d_out);
m.impl("upsample_trilinear3d", wrap_upsample_trilinear3d);
m.impl("upsample_trilinear3d_backward.grad_input", wrap_upsample_trilinear3d_backward_grad_input);
m.impl("upsample_trilinear3d_backward", wrap_upsample_trilinear3d_backward);
m.impl("upsample_nearest1d.out", wrap_upsample_nearest1d_out);
m.impl("_upsample_nearest_exact1d.out", wrap__upsample_nearest_exact1d_out);
m.impl("upsample_nearest1d", wrap_upsample_nearest1d);
m.impl("_upsample_nearest_exact1d", wrap__upsample_nearest_exact1d);
m.impl("upsample_nearest1d_backward.grad_input", wrap_upsample_nearest1d_backward_grad_input);
m.impl("_upsample_nearest_exact1d_backward.grad_input", wrap__upsample_nearest_exact1d_backward_grad_input);
m.impl("upsample_nearest1d_backward", wrap_upsample_nearest1d_backward);
m.impl("_upsample_nearest_exact1d_backward", wrap__upsample_nearest_exact1d_backward);
m.impl("upsample_nearest2d.out", wrap_upsample_nearest2d_out);
m.impl("_upsample_nearest_exact2d.out", wrap__upsample_nearest_exact2d_out);
m.impl("upsample_nearest2d", wrap_upsample_nearest2d);
m.impl("_upsample_nearest_exact2d", wrap__upsample_nearest_exact2d);
m.impl("upsample_nearest2d_backward.grad_input", wrap_upsample_nearest2d_backward_grad_input);
m.impl("_upsample_nearest_exact2d_backward.grad_input", wrap__upsample_nearest_exact2d_backward_grad_input);
m.impl("upsample_nearest2d_backward", wrap_upsample_nearest2d_backward);
m.impl("_upsample_nearest_exact2d_backward", wrap__upsample_nearest_exact2d_backward);
m.impl("upsample_nearest3d.out", wrap_upsample_nearest3d_out);
m.impl("_upsample_nearest_exact3d.out", wrap__upsample_nearest_exact3d_out);
m.impl("upsample_nearest3d", wrap_upsample_nearest3d);
m.impl("_upsample_nearest_exact3d", wrap__upsample_nearest_exact3d);
m.impl("upsample_nearest3d_backward.grad_input", wrap_upsample_nearest3d_backward_grad_input);
m.impl("_upsample_nearest_exact3d_backward.grad_input", wrap__upsample_nearest_exact3d_backward_grad_input);
m.impl("upsample_nearest3d_backward", wrap_upsample_nearest3d_backward);
m.impl("_upsample_nearest_exact3d_backward", wrap__upsample_nearest_exact3d_backward);
...
m.impl("_slow_conv2d_forward.output", wrap__slow_conv2d_forward_output);
m.impl("_slow_conv2d_forward", wrap__slow_conv2d_forward);
m.impl("_slow_conv2d_backward.grad_input", wrap__slow_conv2d_backward_grad_input);
m.impl("_slow_conv2d_backward.output_mask", wrap__slow_conv2d_backward_output_mask);
m.impl("_conv_depthwise2d.out", wrap__conv_depthwise2d_out);
m.impl("_conv_depthwise2d", wrap__conv_depthwise2d);
m.impl("_conv_depthwise2d_backward.grad_input", wrap__conv_depthwise2d_backward_grad_input);
m.impl("_conv_depthwise2d_backward.output_mask", wrap__conv_depthwise2d_backward_output_mask);
...
m.impl("special_entr", wrap_special_entr);
m.impl("special_entr.out", wrap_special_entr_out);
m.impl("special_ndtri", wrap_special_ndtri);
m.impl("special_ndtri.out", wrap_special_ndtri_out);
...
m.impl("special_erfcx", wrap_special_erfcx);
m.impl("special_erfcx.out", wrap_special_erfcx_out);
...
m.impl("special_xlog1py", wrap_special_xlog1py);
...
m.impl("special_xlogy", wrap_special_xlogy);
m.impl("special_xlogy.self_scalar", wrap_special_xlogy_self_scalar);
m.impl("special_xlogy.other_scalar", wrap_special_xlogy_other_scalar);
m.impl("special_xlogy.out", wrap_special_xlogy_out);
m.impl("special_xlogy.self_scalar_out", wrap_special_xlogy_self_scalar_out);
m.impl("special_xlogy.other_scalar_out", wrap_special_xlogy_other_scalar_out);
m.impl("special_zeta", wrap_special_zeta);
m.impl("special_zeta.self_scalar", wrap_special_zeta_self_scalar);
m.impl("special_zeta.other_scalar", wrap_special_zeta_other_scalar);
m.impl("special_zeta.out", wrap_special_zeta_out);
m.impl("special_zeta.self_scalar_out", wrap_special_zeta_self_scalar_out);
m.impl("special_zeta.other_scalar_out", wrap_special_zeta_other_scalar_out);
m.impl("special_i0", wrap_special_i0);
m.impl("special_i0.out", wrap_special_i0_out);
m.impl("special_i0e", wrap_special_i0e);
m.impl("special_i0e.out", wrap_special_i0e_out);
m.impl("special_i1", wrap_special_i1);
m.impl("special_i1.out", wrap_special_i1_out);
m.impl("special_i1e", wrap_special_i1e);
...
m.impl("special_polygamma", wrap_special_polygamma);
m.impl("special_polygamma.out", wrap_special_polygamma_out);
m.impl("special_logsumexp", wrap_special_logsumexp);
m.impl("special_logsumexp.out", wrap_special_logsumexp_out);
m.impl("special_expit", wrap_special_expit);
m.impl("special_expit.out", wrap_special_expit_out);
m.impl("special_sinc", wrap_special_sinc);
m.impl("special_sinc.out", wrap_special_sinc_out);
m.impl("special_round", wrap_special_round);
m.impl("special_round.out", wrap_special_round_out);
m.impl("special_log1p", wrap_special_log1p);
m.impl("special_log1p.out", wrap_special_log1p_out);
m.impl("special_log_softmax", wrap_special_log_softmax);
m.impl("special_gammainc.out", wrap_special_gammainc_out);
m.impl("special_gammainc", wrap_special_gammainc);
m.impl("special_gammaincc.out", wrap_special_gammaincc_out);
m.impl("special_gammaincc", wrap_special_gammaincc);
m.impl("special_multigammaln", wrap_special_multigammaln);
m.impl("special_multigammaln.out", wrap_special_multigammaln_out);
m.impl("special_softmax", wrap_special_softmax);
...
m.impl("fft_hfft2", wrap_fft_hfft2);
m.impl("fft_hfft2.out", wrap_fft_hfft2_out);
m.impl("fft_ihfft2", wrap_fft_ihfft2);
m.impl("fft_ihfft2.out", wrap_fft_ihfft2_out);
...
m.impl("fft_hfftn", wrap_fft_hfftn);
m.impl("fft_hfftn.out", wrap_fft_hfftn_out);
m.impl("fft_ihfftn", wrap_fft_ihfftn);
m.impl("fft_ihfftn.out", wrap_fft_ihfftn_out);
...
m.impl("linalg_cross", wrap_linalg_cross);
m.impl("linalg_cross.out", wrap_linalg_cross_out);
m.impl("linalg_det", wrap_linalg_det);
m.impl("linalg_det.out", wrap_linalg_det_out);
m.impl("det", wrap_det);
m.impl("_det_lu_based_helper", wrap__det_lu_based_helper);
m.impl("_det_lu_based_helper_backward_helper", wrap__det_lu_based_helper_backward_helper);
m.impl("linalg_lstsq", wrap_linalg_lstsq);
m.impl("linalg_lstsq.out", wrap_linalg_lstsq_out);
m.impl("linalg_matmul", wrap_linalg_matmul);
m.impl("linalg_matmul.out", wrap_linalg_matmul_out);
m.impl("linalg_matrix_exp", wrap_linalg_matrix_exp);
...
m.impl("linalg_pinv.atol_rtol_tensor", wrap_linalg_pinv_atol_rtol_tensor);
m.impl("linalg_pinv.atol_rtol_tensor_out", wrap_linalg_pinv_atol_rtol_tensor_out);
m.impl("linalg_pinv.atol_rtol_float", wrap_linalg_pinv_atol_rtol_float);
m.impl("linalg_pinv.atol_rtol_float_out", wrap_linalg_pinv_atol_rtol_float_out);
...
m.impl("linalg_matrix_rank.atol_rtol_tensor", wrap_linalg_matrix_rank_atol_rtol_tensor);
m.impl("linalg_matrix_rank.atol_rtol_tensor_out", wrap_linalg_matrix_rank_atol_rtol_tensor_out);
m.impl("linalg_matrix_rank.atol_rtol_float", wrap_linalg_matrix_rank_atol_rtol_float);
m.impl("linalg_matrix_rank.atol_rtol_float_out", wrap_linalg_matrix_rank_atol_rtol_float_out);
...
m.impl("_test_warn_in_autograd", wrap__test_warn_in_autograd);
