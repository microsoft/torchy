...
at::Tensor wrap__cast_Byte(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, bool non_blocking) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H__CAST_BYTE, scalarTypeToTypeMeta(kByte), self.device());
...
at::Tensor wrap__cast_Char(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, bool non_blocking) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H__CAST_CHAR, scalarTypeToTypeMeta(kChar), self.device());
  trace.append_arg(self);trace.append_arg(non_blocking);
  return tt;
}
...
at::Tensor wrap__cast_Double(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, bool non_blocking) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H__CAST_DOUBLE, scalarTypeToTypeMeta(kDouble), self.device());
  trace.append_arg(self);trace.append_arg(non_blocking);
  return tt;
}
...
at::Tensor wrap__cast_Float(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, bool non_blocking) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H__CAST_FLOAT, scalarTypeToTypeMeta(kFloat), self.device());
  trace.append_arg(self);trace.append_arg(non_blocking);
  return tt;
}
...
at::Tensor wrap__cast_Int(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, bool non_blocking) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H__CAST_INT, scalarTypeToTypeMeta(kInt), self.device());
  trace.append_arg(self);trace.append_arg(non_blocking);
  return tt;
}
...
at::Tensor wrap__cast_Long(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, bool non_blocking) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H__CAST_LONG, scalarTypeToTypeMeta(kLong), self.device());
  trace.append_arg(self);trace.append_arg(non_blocking);
  return tt;
}
...
at::Tensor wrap__cast_Short(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, bool non_blocking) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H__CAST_SHORT, scalarTypeToTypeMeta(kShort), self.device());
  trace.append_arg(self);trace.append_arg(non_blocking);
  return tt;
}
...
at::Tensor wrap__cast_Half(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, bool non_blocking) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H__CAST_HALF, scalarTypeToTypeMeta(kHalf), self.device());
  trace.append_arg(self);trace.append_arg(non_blocking);
  return tt;
}
...
at::Tensor wrap__shape_as_tensor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H__SHAPE_AS_TENSOR, scalarTypeToTypeMeta(kLong), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_abs(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_ABS, scalarTypeToTypeMeta(toValueType(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_absolute(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_ABSOLUTE, scalarTypeToTypeMeta(toValueType(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_angle(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_ANGLE, scalarTypeToTypeMeta(to_real_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_view_as_real(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_VIEW_AS_REAL, scalarTypeToTypeMeta(toValueType(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap__view_as_real_physical(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H__VIEW_AS_REAL_PHYSICAL, scalarTypeToTypeMeta(toValueType(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_real(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_REAL, scalarTypeToTypeMeta(toValueType(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_imag(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_IMAG, scalarTypeToTypeMeta(toValueType(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_arccos(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_ARCCOS, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_add_Tensor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other, const at::Scalar & alpha) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_ADD_TENSOR, scalarTypeToTypeMeta(promote_tys(self, other)), self.device());
...
at::Tensor wrap__add_relu_Tensor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other, const at::Scalar & alpha) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H__ADD_RELU_TENSOR, scalarTypeToTypeMeta(promote_tys(self, other)), self.device());
  trace.append_arg(self);trace.append_arg(other);trace.append_arg(alpha);
  return tt;
}
...
at::Tensor wrap_add_Scalar(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Scalar & other, const at::Scalar & alpha) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_ADD_SCALAR, scalarTypeToTypeMeta(bool_to_int(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(other);trace.append_arg(alpha);
  return tt;
}
...
at::Tensor wrap_addr(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & vec1, const at::Tensor & vec2, const at::Scalar & beta, const at::Scalar & alpha) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_ADDR, scalarTypeToTypeMeta(promote_tys(self, vec1, vec2)), self.device());
...
at::Tensor wrap_argmin(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, c10::optional<int64_t> dim, bool keepdim) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_ARGMIN, scalarTypeToTypeMeta(kLong), self.device());
  trace.append_arg(self);trace.append_arg(dim);trace.append_arg(keepdim);
  return tt;
}
...
at::Tensor wrap_arccosh(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_ARCCOSH, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_arcsinh(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_ARCSINH, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_arctanh(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_ARCTANH, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_asin(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_ASIN, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_arcsin(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_ARCSIN, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_arctan(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_ARCTAN, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_bincount(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const c10::optional<at::Tensor> & weights, int64_t minlength) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_BINCOUNT, scalarTypeToTypeMeta(to_float_double(self.dtype().toScalarType())), self.device());
...
at::Tensor wrap_copysign_Scalar(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Scalar & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_COPYSIGN_SCALAR, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_logical_not(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_LOGICAL_NOT, scalarTypeToTypeMeta(kBool), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_logical_xor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_LOGICAL_XOR, scalarTypeToTypeMeta(kBool), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_logical_and(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_LOGICAL_AND, scalarTypeToTypeMeta(kBool), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_logical_or(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_LOGICAL_OR, scalarTypeToTypeMeta(kBool), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_block_diag(c10::DispatchKeySet dispatchKeySet, at::TensorList tensors) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_BLOCK_DIAG, tensors);
...
at::Tensor wrap_complex(c10::DispatchKeySet dispatchKeySet, const at::Tensor & real, const at::Tensor & imag) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_COMPLEX, scalarTypeToTypeMeta(to_complex(real.dtype().toScalarType())), real.device());
...
at::Tensor wrap_polar(c10::DispatchKeySet dispatchKeySet, const at::Tensor & abs, const at::Tensor & angle) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_POLAR, scalarTypeToTypeMeta(to_complex(abs.dtype().toScalarType())), abs.device());
...
at::Tensor wrap_count_nonzero_dim_IntList(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, at::IntArrayRef dim) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_COUNT_NONZERO_DIM_INTLIST, scalarTypeToTypeMeta(kLong), self.device());
...
at::Tensor wrap_count_nonzero(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, c10::optional<int64_t> dim) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_COUNT_NONZERO, scalarTypeToTypeMeta(kLong), self.device());
...
at::Tensor wrap_cumprod(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, int64_t dim, c10::optional<at::ScalarType> dtype) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_CUMPROD, self, dtype, nullopt);
...
at::Tensor wrap_cumsum(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, int64_t dim, c10::optional<at::ScalarType> dtype) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_CUMSUM, self, dtype, nullopt);
  trace.append_arg(self);trace.append_arg(dim);trace.append_arg(std::move(dtype));
  return tt;
}
...
at::Tensor wrap_div_Tensor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_DIV_TENSOR, scalarTypeToTypeMeta(to_float2(self.dtype().toScalarType(), other.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_div_Tensor_mode(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other, c10::optional<c10::string_view> rounding_mode) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_DIV_TENSOR_MODE, scalarTypeToTypeMeta(to_float2(self.dtype().toScalarType(), other.dtype().toScalarType())), self.device());
...
at::Tensor wrap_div_Scalar(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Scalar & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_DIV_SCALAR, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_div_Scalar_mode(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Scalar & other, c10::optional<c10::string_view> rounding_mode) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_DIV_SCALAR_MODE, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(other);trace.append_arg(std::move(rounding_mode));
  return tt;
}
...
at::Tensor wrap_divide_Tensor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_DIVIDE_TENSOR, scalarTypeToTypeMeta(to_float2(self.dtype().toScalarType(), other.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_divide_Scalar(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Scalar & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_DIVIDE_SCALAR, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_divide_Tensor_mode(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other, c10::optional<c10::string_view> rounding_mode) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_DIVIDE_TENSOR_MODE, scalarTypeToTypeMeta(to_float2(self.dtype().toScalarType(), other.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(other);trace.append_arg(std::move(rounding_mode));
  return tt;
}
...
at::Tensor wrap_divide_Scalar_mode(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Scalar & other, c10::optional<c10::string_view> rounding_mode) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_DIVIDE_SCALAR_MODE, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(other);trace.append_arg(std::move(rounding_mode));
  return tt;
}
...
at::Tensor wrap_true_divide_Tensor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_TRUE_DIVIDE_TENSOR, scalarTypeToTypeMeta(to_float2(self.dtype().toScalarType(), other.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_true_divide_Scalar(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Scalar & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_TRUE_DIVIDE_SCALAR, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_row_stack(c10::DispatchKeySet dispatchKeySet, at::TensorList tensors) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_ROW_STACK, tensors);
  trace.append_arg(std::move(tensors));
  return tt;
}
...
at::Tensor wrap_floor_divide(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_FLOOR_DIVIDE, scalarTypeToTypeMeta(promote_tys(self, other)), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_isclose(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other, double rtol, double atol, bool equal_nan) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_ISCLOSE, scalarTypeToTypeMeta(kBool), self.device());
...
at::Tensor wrap_isreal(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_ISREAL, scalarTypeToTypeMeta(kBool), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_kl_div(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & target, int64_t reduction, bool log_target) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_KL_DIV, scalarTypeToTypeMeta(to_float2_2(self.dtype().toScalarType(), target.dtype().toScalarType())), self.device());
...
at::Tensor wrap_kron(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_KRON, scalarTypeToTypeMeta(promote_tys(self, other)), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_ldexp_Tensor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_LDEXP_TENSOR, scalarTypeToTypeMeta(to_float2_3(self.dtype().toScalarType(), other.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_log1p(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_LOG1P, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_logaddexp(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_LOGADDEXP, scalarTypeToTypeMeta(promote_tys(self, other)), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_logaddexp2(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_LOGADDEXP2, scalarTypeToTypeMeta(promote_tys(self, other)), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_xlogy_Tensor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_XLOGY_TENSOR, scalarTypeToTypeMeta(to_float2(self.dtype().toScalarType(), other.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_xlogy_Scalar_Self(c10::DispatchKeySet dispatchKeySet, const at::Scalar & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_XLOGY_SCALAR_SELF, scalarTypeToTypeMeta(to_float(other.dtype().toScalarType())), other.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_xlogy_Scalar_Other(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Scalar & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_XLOGY_SCALAR_OTHER, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_margin_ranking_loss(c10::DispatchKeySet dispatchKeySet, const at::Tensor & input1, const at::Tensor & input2, const at::Tensor & target, double margin, int64_t reduction) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_MARGIN_RANKING_LOSS, scalarTypeToTypeMeta(to_float3(input1.dtype().toScalarType(), input2.dtype().toScalarType(), target.dtype().toScalarType())), input1.device());
  trace.append_arg(input1);trace.append_arg(input2);trace.append_arg(target);trace.append_arg(margin);trace.append_arg(reduction);
  return tt;
}
...
at::Tensor wrap_mul_Tensor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_MUL_TENSOR, scalarTypeToTypeMeta(promote_tys(self, other)), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_mul_Scalar(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Scalar & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_MUL_SCALAR, scalarTypeToTypeMeta(bool_to_int(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_multiply_Tensor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_MULTIPLY_TENSOR, scalarTypeToTypeMeta(promote_tys(self, other)), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_multiply_Scalar(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Scalar & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_MULTIPLY_SCALAR, scalarTypeToTypeMeta(bool_to_int(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_mvlgamma(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, int64_t p) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_MVLGAMMA, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
...
at::Tensor wrap_poisson_nll_loss(c10::DispatchKeySet dispatchKeySet, const at::Tensor & input, const at::Tensor & target, bool log_input, bool full, double eps, int64_t reduction) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_POISSON_NLL_LOSS, scalarTypeToTypeMeta(to_float2_4(input.dtype().toScalarType(), target.dtype().toScalarType())), input.device());
...
at::Tensor wrap_rad2deg(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_RAD2DEG, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_deg2rad(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_DEG2RAD, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_silu_backward(c10::DispatchKeySet dispatchKeySet, const at::Tensor & grad_output, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SILU_BACKWARD, self.dtype(), grad_output.device());
...
at::Tensor wrap_sigmoid(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SIGMOID, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_logit(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, c10::optional<double> eps) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_LOGIT, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
...
at::Tensor wrap_stack(c10::DispatchKeySet dispatchKeySet, at::TensorList tensors, int64_t dim) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_STACK, tensors);
  trace.append_arg(std::move(tensors));trace.append_arg(dim);
  return tt;
}
...
at::Tensor wrap__stack(c10::DispatchKeySet dispatchKeySet, at::TensorList tensors, int64_t dim) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H__STACK, tensors);
  trace.append_arg(std::move(tensors));trace.append_arg(dim);
  return tt;
}
...
at::Tensor wrap_hstack(c10::DispatchKeySet dispatchKeySet, at::TensorList tensors) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_HSTACK, tensors);
  trace.append_arg(std::move(tensors));
  return tt;
}
...
at::Tensor wrap_vstack(c10::DispatchKeySet dispatchKeySet, at::TensorList tensors) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_VSTACK, tensors);
  trace.append_arg(std::move(tensors));
  return tt;
}
...
at::Tensor wrap_dstack(c10::DispatchKeySet dispatchKeySet, at::TensorList tensors) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_DSTACK, tensors);
  trace.append_arg(std::move(tensors));
  return tt;
}
...
at::Tensor wrap_sum_dim_IntList(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, at::IntArrayRef dim, bool keepdim, c10::optional<at::ScalarType> dtype) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SUM_DIM_INTLIST, self, dtype, nullopt);
  trace.append_arg(self);trace.append_arg(std::move(dim));trace.append_arg(keepdim);trace.append_arg(std::move(dtype));
  return tt;
}
...
at::Tensor wrap_sum_to_size(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, at::IntArrayRef size) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SUM_TO_SIZE, scalarTypeToTypeMeta(integrals_to_int(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(std::move(size));
  return tt;
}
...
at::Tensor wrap_sqrt(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SQRT, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_square(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SQUARE, scalarTypeToTypeMeta(bool_to_int(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_std(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, bool unbiased) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_STD, scalarTypeToTypeMeta(toValueType(self.dtype().toScalarType())), self.device());
...
at::Tensor wrap_std_dim(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, at::IntArrayRef dim, bool unbiased, bool keepdim) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_STD_DIM, scalarTypeToTypeMeta(toValueType(self.dtype().toScalarType())), self.device());
...
at::Tensor wrap_std_correction(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, c10::optional<at::IntArrayRef> dim, c10::optional<int64_t> correction, bool keepdim) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_STD_CORRECTION, scalarTypeToTypeMeta(toValueType(self.dtype().toScalarType())), self.device());
...
at::Tensor wrap_prod_dim_int(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, int64_t dim, bool keepdim, c10::optional<at::ScalarType> dtype) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_PROD_DIM_INT, self, dtype, nullopt);
...
at::Tensor wrap_tanh(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_TANH, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_threshold_backward(c10::DispatchKeySet dispatchKeySet, const at::Tensor & grad_output, const at::Tensor & self, const at::Scalar & threshold) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_THRESHOLD_BACKWARD, scalarTypeToTypeMeta(promote_tys(grad_output, self)), grad_output.device());
...
at::Tensor wrap_vander(c10::DispatchKeySet dispatchKeySet, const at::Tensor & x, c10::optional<int64_t> N, bool increasing) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_VANDER, scalarTypeToTypeMeta(integrals_to_int(x.dtype().toScalarType())), x.device());
...
at::Tensor wrap_var(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, bool unbiased) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_VAR, scalarTypeToTypeMeta(toValueType(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(unbiased);
  return tt;
}
...
at::Tensor wrap_var_dim(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, at::IntArrayRef dim, bool unbiased, bool keepdim) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_VAR_DIM, scalarTypeToTypeMeta(toValueType(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(std::move(dim));trace.append_arg(unbiased);trace.append_arg(keepdim);
  return tt;
}
...
at::Tensor wrap_var_correction(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, c10::optional<at::IntArrayRef> dim, c10::optional<int64_t> correction, bool keepdim) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_VAR_CORRECTION, scalarTypeToTypeMeta(toValueType(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(std::move(dim));trace.append_arg(correction);trace.append_arg(keepdim);
  return tt;
}
...
at::Tensor wrap_where_ScalarSelf(c10::DispatchKeySet dispatchKeySet, const at::Tensor & condition, const at::Scalar & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_WHERE_SCALARSELF, scalarTypeToTypeMeta(kLong), condition.device());
  trace.append_arg(condition);trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_where_ScalarOther(c10::DispatchKeySet dispatchKeySet, const at::Tensor & condition, const at::Tensor & self, const at::Scalar & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_WHERE_SCALAROTHER, scalarTypeToTypeMeta(kLong), condition.device());
  trace.append_arg(condition);trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_where_Scalar(c10::DispatchKeySet dispatchKeySet, const at::Tensor & condition, const at::Scalar & self, const at::Scalar & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_WHERE_SCALAR, scalarTypeToTypeMeta(kLong), condition.device());
  trace.append_arg(condition);trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_norm_Scalar(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Scalar & p) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_NORM_SCALAR, scalarTypeToTypeMeta(toValueType(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(p);
  return tt;
}
...
at::Tensor wrap_norm_ScalarOpt_dim(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const c10::optional<at::Scalar> & p, at::IntArrayRef dim, bool keepdim) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_NORM_SCALAROPT_DIM, scalarTypeToTypeMeta(toValueType(self.dtype().toScalarType())), self.device());
...
at::Tensor wrap_frobenius_norm(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_FROBENIUS_NORM, scalarTypeToTypeMeta(toValueType(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_frobenius_norm_dim(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, at::IntArrayRef dim, bool keepdim) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_FROBENIUS_NORM_DIM, scalarTypeToTypeMeta(toValueType(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(std::move(dim));trace.append_arg(keepdim);
  return tt;
}
...
at::Tensor wrap_sub_Tensor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other, const at::Scalar & alpha) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SUB_TENSOR, scalarTypeToTypeMeta(promote_tys(self, other)), self.device());
  trace.append_arg(self);trace.append_arg(other);trace.append_arg(alpha);
  return tt;
}
...
at::Tensor wrap_subtract_Tensor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other, const at::Scalar & alpha) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SUBTRACT_TENSOR, scalarTypeToTypeMeta(promote_tys(self, other)), self.device());
  trace.append_arg(self);trace.append_arg(other);trace.append_arg(alpha);
  return tt;
}
...
at::Tensor wrap_rsub_Tensor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other, const at::Scalar & alpha) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_RSUB_TENSOR, scalarTypeToTypeMeta(promote_tys(self, other)), self.device());
  trace.append_arg(self);trace.append_arg(other);trace.append_arg(alpha);
  return tt;
}
...
at::Tensor wrap_dequantize_self(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_DEQUANTIZE_SELF, scalarTypeToTypeMeta(kFloat), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap__make_per_tensor_quantized_tensor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, double scale, int64_t zero_point) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H__MAKE_PER_TENSOR_QUANTIZED_TENSOR, scalarTypeToTypeMeta(toQIntType(self.dtype().toScalarType())), self.device());
...
at::Tensor wrap__make_per_channel_quantized_tensor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & scale, const at::Tensor & zero_point, int64_t axis) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H__MAKE_PER_CHANNEL_QUANTIZED_TENSOR, scalarTypeToTypeMeta(toQIntType(self.dtype().toScalarType())), self.device());
...
at::Tensor wrap___lshift___Tensor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H___LSHIFT___TENSOR, scalarTypeToTypeMeta(promote_tys(self, other)), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap___rshift___Tensor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H___RSHIFT___TENSOR, scalarTypeToTypeMeta(promote_tys(self, other)), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_not_equal_Scalar(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Scalar & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_NOT_EQUAL_SCALAR, scalarTypeToTypeMeta(kBool), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_not_equal_Tensor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_NOT_EQUAL_TENSOR, scalarTypeToTypeMeta(kBool), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_ge_Scalar(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Scalar & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_GE_SCALAR, scalarTypeToTypeMeta(kBool), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_ge_Tensor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_GE_TENSOR, scalarTypeToTypeMeta(kBool), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_greater_equal_Scalar(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Scalar & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_GREATER_EQUAL_SCALAR, scalarTypeToTypeMeta(kBool), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_greater_equal_Tensor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_GREATER_EQUAL_TENSOR, scalarTypeToTypeMeta(kBool), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_le_Scalar(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Scalar & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_LE_SCALAR, scalarTypeToTypeMeta(kBool), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_le_Tensor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_LE_TENSOR, scalarTypeToTypeMeta(kBool), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_less_equal_Scalar(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Scalar & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_LESS_EQUAL_SCALAR, scalarTypeToTypeMeta(kBool), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_less_equal_Tensor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_LESS_EQUAL_TENSOR, scalarTypeToTypeMeta(kBool), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_nonzero(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_NONZERO, scalarTypeToTypeMeta(kLong), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_multinomial(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, int64_t num_samples, bool replacement, c10::optional<at::Generator> generator) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_MULTINOMIAL, scalarTypeToTypeMeta(kLong), self.device());
...
at::Tensor wrap_signbit(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SIGNBIT, scalarTypeToTypeMeta(kBool), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_dist(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other, const at::Scalar & p) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_DIST, scalarTypeToTypeMeta(to_real2(self.dtype().toScalarType(), other.dtype().toScalarType())), self.device());
...
at::Tensor wrap_fmod_Tensor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_FMOD_TENSOR, scalarTypeToTypeMeta(promote_tys(self, other)), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_remainder_Scalar_Tensor(c10::DispatchKeySet dispatchKeySet, const at::Scalar & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_REMAINDER_SCALAR_TENSOR, scalarTypeToTypeMeta(bool_to_int(other.dtype().toScalarType())), other.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_max_other(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_MAX_OTHER, scalarTypeToTypeMeta(promote_tys(self, other)), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_min_other(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_MIN_OTHER, scalarTypeToTypeMeta(promote_tys(self, other)), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_all(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_ALL, scalarTypeToTypeMeta(bool_byte(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_any(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_ANY, scalarTypeToTypeMeta(bool_byte(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_pow_Tensor_Scalar(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Scalar & exponent) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_POW_TENSOR_SCALAR, scalarTypeToTypeMeta(bool_to_int(self.dtype().toScalarType())), self.device());
...
at::Tensor wrap_float_power_Tensor_Tensor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & exponent) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_FLOAT_POWER_TENSOR_TENSOR, scalarTypeToTypeMeta(to_double2(self.dtype().toScalarType(), exponent.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(exponent);
  return tt;
}
...
at::Tensor wrap_float_power_Scalar(c10::DispatchKeySet dispatchKeySet, const at::Scalar & self, const at::Tensor & exponent) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_FLOAT_POWER_SCALAR, scalarTypeToTypeMeta(to_double(exponent.dtype().toScalarType())), exponent.device());
  trace.append_arg(self);trace.append_arg(exponent);
  return tt;
}
...
at::Tensor wrap_float_power_Tensor_Scalar(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Scalar & exponent) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_FLOAT_POWER_TENSOR_SCALAR, scalarTypeToTypeMeta(to_double(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(exponent);
  return tt;
}
...
at::Tensor wrap_bucketize_Tensor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & boundaries, bool out_int32, bool right) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_BUCKETIZE_TENSOR, scalarTypeToTypeMeta(kLong), self.device());
...
at::Tensor wrap_bucketize_Scalar(c10::DispatchKeySet dispatchKeySet, const at::Scalar & self, const at::Tensor & boundaries, bool out_int32, bool right) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_BUCKETIZE_SCALAR, scalarTypeToTypeMeta(kLong), boundaries.device());
  trace.append_arg(self);trace.append_arg(boundaries);trace.append_arg(out_int32);trace.append_arg(right);
  return tt;
}
...
at::Tensor wrap_searchsorted_Tensor(c10::DispatchKeySet dispatchKeySet, const at::Tensor & sorted_sequence, const at::Tensor & self, bool out_int32, bool right) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SEARCHSORTED_TENSOR, scalarTypeToTypeMeta(kLong), sorted_sequence.device());
...
at::Tensor wrap_searchsorted_Scalar(c10::DispatchKeySet dispatchKeySet, const at::Tensor & sorted_sequence, const at::Scalar & self, bool out_int32, bool right) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SEARCHSORTED_SCALAR, scalarTypeToTypeMeta(kLong), sorted_sequence.device());
  trace.append_arg(sorted_sequence);trace.append_arg(self);trace.append_arg(out_int32);trace.append_arg(right);
  return tt;
}
...
at::Tensor wrap_mse_loss(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & target, int64_t reduction) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_MSE_LOSS, scalarTypeToTypeMeta(promote_tys(self, target)), self.device());
...
at::Tensor wrap_l1_loss(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & target, int64_t reduction) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_L1_LOSS, scalarTypeToTypeMeta(toValueType(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(target);trace.append_arg(reduction);
  return tt;
}
...
at::Tensor wrap_smooth_l1_loss(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & target, int64_t reduction, double beta) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SMOOTH_L1_LOSS, scalarTypeToTypeMeta(promote_tys(self, target)), self.device());
...
at::Tensor wrap_hardtanh_backward(c10::DispatchKeySet dispatchKeySet, const at::Tensor & grad_output, const at::Tensor & self, const at::Scalar & min_val, const at::Scalar & max_val) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_HARDTANH_BACKWARD, scalarTypeToTypeMeta(promote_tys(grad_output, self)), grad_output.device());
...
at::Tensor wrap_hardswish_backward(c10::DispatchKeySet dispatchKeySet, const at::Tensor & grad_output, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_HARDSWISH_BACKWARD, scalarTypeToTypeMeta(promote_tys(grad_output, self)), grad_output.device());
  trace.append_arg(grad_output);trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_rrelu_with_noise_backward(c10::DispatchKeySet dispatchKeySet, const at::Tensor & grad_output, const at::Tensor & self, const at::Tensor & noise, const at::Scalar & lower, const at::Scalar & upper, bool training, bool self_is_result) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_RRELU_WITH_NOISE_BACKWARD, scalarTypeToTypeMeta(to_float2(grad_output.dtype().toScalarType(), self.dtype().toScalarType())), grad_output.device());
...
at::Tensor wrap_sigmoid_backward(c10::DispatchKeySet dispatchKeySet, const at::Tensor & grad_output, const at::Tensor & output) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SIGMOID_BACKWARD, scalarTypeToTypeMeta(promote_tys(grad_output, output)), grad_output.device());
...
at::Tensor wrap_logit_backward(c10::DispatchKeySet dispatchKeySet, const at::Tensor & grad_output, const at::Tensor & self, c10::optional<double> eps) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_LOGIT_BACKWARD, scalarTypeToTypeMeta(promote_tys(grad_output, self)), grad_output.device());
...
at::Tensor wrap_tanh_backward(c10::DispatchKeySet dispatchKeySet, const at::Tensor & grad_output, const at::Tensor & output) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_TANH_BACKWARD, scalarTypeToTypeMeta(promote_tys(grad_output, output)), grad_output.device());
  trace.append_arg(grad_output);trace.append_arg(output);
  return tt;
}
...
at::Tensor wrap_column_stack(c10::DispatchKeySet dispatchKeySet, at::TensorList tensors) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_COLUMN_STACK, tensors);
  trace.append_arg(std::move(tensors));
  return tt;
}
...
at::Tensor wrap_special_expm1(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SPECIAL_EXPM1, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_special_exp2(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SPECIAL_EXP2, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_special_psi(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SPECIAL_PSI, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_special_digamma(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SPECIAL_DIGAMMA, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_special_gammaln(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SPECIAL_GAMMALN, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_special_erf(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SPECIAL_ERF, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_special_erfc(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SPECIAL_ERFC, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_special_erfinv(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SPECIAL_ERFINV, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_special_ndtr(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SPECIAL_NDTR, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_special_xlog1py_self_scalar(c10::DispatchKeySet dispatchKeySet, const at::Scalar & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SPECIAL_XLOG1PY_SELF_SCALAR, scalarTypeToTypeMeta(to_float(other.dtype().toScalarType())), other.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_special_xlog1py_other_scalar(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Scalar & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SPECIAL_XLOG1PY_OTHER_SCALAR, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_special_zeta(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SPECIAL_ZETA, scalarTypeToTypeMeta(to_float2(self.dtype().toScalarType(), other.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_special_zeta_self_scalar(c10::DispatchKeySet dispatchKeySet, const at::Scalar & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SPECIAL_ZETA_SELF_SCALAR, scalarTypeToTypeMeta(to_float(other.dtype().toScalarType())), other.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_special_zeta_other_scalar(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Scalar & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SPECIAL_ZETA_OTHER_SCALAR, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_special_i0(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SPECIAL_I0, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_special_logit(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, c10::optional<double> eps) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SPECIAL_LOGIT, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(eps);
  return tt;
}
...
at::Tensor wrap_special_expit(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SPECIAL_EXPIT, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_special_sinc(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SPECIAL_SINC, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_special_log1p(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_SPECIAL_LOG1P, scalarTypeToTypeMeta(to_float(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);
  return tt;
}
...
at::Tensor wrap_fft_fftn(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, c10::optional<at::IntArrayRef> s, c10::optional<at::IntArrayRef> dim, c10::optional<c10::string_view> norm) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_FFT_FFTN, scalarTypeToTypeMeta(to_complex(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(std::move(s));trace.append_arg(std::move(dim));trace.append_arg(std::move(norm));
  return tt;
}
...
at::Tensor wrap_fft_ifftn(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, c10::optional<at::IntArrayRef> s, c10::optional<at::IntArrayRef> dim, c10::optional<c10::string_view> norm) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_FFT_IFFTN, scalarTypeToTypeMeta(to_complex(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(std::move(s));trace.append_arg(std::move(dim));trace.append_arg(std::move(norm));
  return tt;
}
...
at::Tensor wrap_fft_rfftn(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, c10::optional<at::IntArrayRef> s, c10::optional<at::IntArrayRef> dim, c10::optional<c10::string_view> norm) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_FFT_RFFTN, scalarTypeToTypeMeta(to_complex(self.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(std::move(s));trace.append_arg(std::move(dim));trace.append_arg(std::move(norm));
  return tt;
}
...
at::Tensor wrap_fft_fftfreq(c10::DispatchKeySet dispatchKeySet, int64_t n, double d, c10::optional<at::ScalarType> dtype, c10::optional<at::Layout> layout, c10::optional<at::Device> device, c10::optional<bool> pin_memory) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_FFT_FFTFREQ, dtype, device);
...
at::Tensor wrap_fft_rfftfreq(c10::DispatchKeySet dispatchKeySet, int64_t n, double d, c10::optional<at::ScalarType> dtype, c10::optional<at::Layout> layout, c10::optional<at::Device> device, c10::optional<bool> pin_memory) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_FFT_RFFTFREQ, dtype, device);
  trace.append_arg(n);trace.append_arg(d);trace.append_arg(std::move(dtype));trace.append_arg(std::move(layout));trace.append_arg(std::move(device));trace.append_arg(pin_memory);
  return tt;
}
...
at::Tensor wrap_inner(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_INNER, other.dtype(), self.device());
  trace.append_arg(self);trace.append_arg(other);
  return tt;
}
...
at::Tensor wrap_outer(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & vec2) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_OUTER, scalarTypeToTypeMeta(promote_tys(self, vec2)), self.device());
...
at::Tensor wrap_ger(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & vec2) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_GER, scalarTypeToTypeMeta(promote_tys(self, vec2)), self.device());
  trace.append_arg(self);trace.append_arg(vec2);
  return tt;
}
...
at::Tensor wrap_linalg_norm(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const c10::optional<at::Scalar> & ord, c10::optional<at::IntArrayRef> dim, bool keepdim, c10::optional<at::ScalarType> dtype) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_LINALG_NORM, self, dtype, nullopt);
...
at::Tensor wrap_linalg_norm_ord_str(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, c10::string_view ord, c10::optional<at::IntArrayRef> dim, bool keepdim, c10::optional<at::ScalarType> dtype) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_LINALG_NORM_ORD_STR, self, dtype, nullopt);
...
at::Tensor wrap_linalg_vector_norm(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Scalar & ord, c10::optional<at::IntArrayRef> dim, bool keepdim, c10::optional<at::ScalarType> dtype) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_LINALG_VECTOR_NORM, self, dtype, nullopt);
  trace.append_arg(self);trace.append_arg(ord);trace.append_arg(std::move(dim));trace.append_arg(keepdim);trace.append_arg(std::move(dtype));
  return tt;
}
...
at::Tensor wrap_linalg_matrix_norm(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Scalar & ord, at::IntArrayRef dim, bool keepdim, c10::optional<at::ScalarType> dtype) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_LINALG_MATRIX_NORM, self, dtype, nullopt);
  trace.append_arg(self);trace.append_arg(ord);trace.append_arg(std::move(dim));trace.append_arg(keepdim);trace.append_arg(std::move(dtype));
  return tt;
}
...
at::Tensor wrap_linalg_matrix_norm_str_ord(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, c10::string_view ord, at::IntArrayRef dim, bool keepdim, c10::optional<at::ScalarType> dtype) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_LINALG_MATRIX_NORM_STR_ORD, self, dtype, nullopt);
  trace.append_arg(self);trace.append_arg(std::move(ord));trace.append_arg(std::move(dim));trace.append_arg(keepdim);trace.append_arg(std::move(dtype));
  return tt;
}
...
at::Tensor wrap__test_serialization_subcmul(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & other, const at::Scalar & alpha) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H__TEST_SERIALIZATION_SUBCMUL, scalarTypeToTypeMeta(bool_to_int2(self.dtype().toScalarType(), other.dtype().toScalarType())), self.device());
  trace.append_arg(self);trace.append_arg(other);trace.append_arg(alpha);
  return tt;
}
...
at::Tensor wrap__test_ambiguous_defaults_a(c10::DispatchKeySet dispatchKeySet, const at::Tensor & dummy, int64_t a, int64_t b) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H__TEST_AMBIGUOUS_DEFAULTS_A, scalarTypeToTypeMeta(kLong), dummy.device());
...
at::Tensor wrap_flatten_dense_tensors(c10::DispatchKeySet dispatchKeySet, at::TensorList tensors) {
  ...
  auto tt = register_new_tensor(dispatchKeySet, H_FLATTEN_DENSE_TENSORS, tensors);
  trace.append_arg(std::move(tensors));
  return tt;
}
